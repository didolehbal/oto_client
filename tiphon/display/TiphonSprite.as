   ...
   public class TiphonSprite extends Sprite implements IAnimated, IAnimationSpriteHandler, IDestroyable, EntityLookObserver
   {
      ...
      private function render() : void
      {
         ...
         if(_loc14_ == null)
         {
            ...
            {
               _log.error("On ne trouve cette animation, on va jouer l\'animation " + _loc4_ + "_" + this._currentDirection + " à la place.");
            ...
            {
               _log.error("On ne trouve pas cette animation dans cette direction, on va jouer l\'animation " + _loc4_ + "_" + _loc5_ + " à la place.");
