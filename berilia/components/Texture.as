package com.ankamagames.berilia.components
{
   ...
   public class Texture extends GraphicContainer implements FinalizableUIComponent, IRectangle
   {
      ...
      {
         return !!isNaN(this._forcedHeight)?!!this._child?Number(this._child.height):Number(0):Number(this._forcedHeight);
      }
      ...
      {
         return !!isNaN(this._forcedWidth)?!!this._child?Number(this._child.width):Number(0):Number(this._forcedWidth);
      }
      ...
      public function getChildDuration() : uint
      {
         ...
         if(_loc5_ = this._child as DisplayObjectContainer)
         {
            _loc1_ = 0;
            while(_loc1_ < _loc5_.numChildren)
            {
               _loc2_ = DisplayObjectContainer(this._child).getChildAt(_loc1_);
               if(_loc2_ is MovieClip && MovieClip(_loc2_).totalFrames && MovieClip(_loc2_).totalFrames > _loc4_)
               {
                  _loc4_ = MovieClip(_loc2_).totalFrames;
               }
               _loc1_++;
            }
         }
         ...
         {
            _loc3_ = this._child as MovieClip;
            _loc4_ = _loc3_.totalFrames;
         }
         return _loc4_;
      }
      ...
      public function gotoAndPayChild(param1:uint) : void
      {
         ...
         if(_loc5_ = this._child as DisplayObjectContainer)
         {
            ...
            {
               _loc3_ = DisplayObjectContainer(this._child).getChildAt(_loc2_);
               if(_loc3_ is MovieClip)
               {
                  (_loc3_ as MovieClip).gotoAndPlay(param1);
               }
               _loc2_++;
            }
         }
         ...
         {
            (_loc4_ = this._child as MovieClip).gotoAndPlay(param1);
         }
      }
      ...
      public function colorTransform(param1:ColorTransform, param2:int = 0) : void
      {
         ...
         else if(this._child is DisplayObjectContainer)
         {
            ...
            while(_loc4_ < param2)
            {
               ...
               if(!((_loc5_ = _loc3_.getChildAt(0)) is DisplayObjectContainer))
               {
                  break;
               }
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:MovieClip = this._child as MovieClip;
         if(_loc2_)
         {
      ...
      private function onFailed(param1:ResourceErrorEvent) : void
      {
         ...
         var _loc3_:DynamicSecureObject = new DynamicSecureObject();
         _loc3_.cancel = false;
         if(KernelEventsManager.getInstance().isRegisteredEvent(BeriliaHookList.TextureLoadFailed.name))
         {
            this._finalized = true;
            KernelEventsManager.getInstance().processCallback(BeriliaHookList.TextureLoadFailed,SecureCenter.secure(this,!!getUi()?Boolean(getUi().uiModule.trusted):false),_loc3_);
         }
         else
         {
         ...
         dispatchEvent(new TextureLoadFailedEvent(this,_loc3_));
         Berilia.getInstance().handler.process(new TextureLoadFailMessage(this));
         if(!_loc3_.cancel && param1.uri == this._uri)
         {
            this._loader = null;
            if(param1.uri == this._uri)
            {
               ...
               {
                  _loc2_ = new Shape();
                  _loc2_.graphics.beginFill(16711935);
                  _loc2_.graphics.drawRect(0,0,!isNaN(this._forcedWidth) && this._forcedWidth != 0?Number(this._forcedWidth):Number(10),!isNaN(this._forcedHeight) && this._forcedHeight != 0?Number(this._forcedHeight):Number(10));
                  _loc2_.graphics.endFill();
                  this._child = addChild(_loc2_);
               }
            }
         }
         this._finalized = true;
