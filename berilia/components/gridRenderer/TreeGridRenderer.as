package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class TreeGridRenderer implements IGridRenderer
   {
      ...
      {
         var _loc5_:TreeData = null;
         var _loc6_:Sprite;
         (_loc6_ = new Sprite()).mouseEnabled = false;
         this._indexRef[_loc6_] = param1;
         _loc5_ = param1;
         var _loc7_:Texture;
         (_loc7_ = new Texture()).mouseEnabled = true;
         _loc7_.width = 10;
         _loc7_.height = this._grid.slotHeight + 1;
         _loc7_.y = (this._grid.slotHeight - 18) / 2;
         if(_loc5_)
         {
            _loc7_.x = _loc5_.depth * _loc7_.width;
            if(_loc5_.children && _loc5_.children.length)
            {
               _loc7_.uri = this._expendBtnUri;
               _loc7_.buttonMode = true;
            }
            else if(_loc5_.parent.children.indexOf(_loc5_) == _loc5_.parent.children.length - 1)
            {
         ...
         _loc7_.finalize();
         var _loc8_:Label;
         (_loc8_ = new Label()).mouseEnabled = true;
         ...
         this.updateBackground(_loc6_,param2,param3);
      ...
      private function onRelease(param1:MouseEvent) : void
      {
         ...
         var _loc3_:TreeData = this._indexRef[param1.target.parent];
         _loc3_.expend = !_loc3_.expend;
         Tree(this._grid).rerender();
         for each(_loc2_ in Berilia.getInstance().UISoundListeners)
         {
            _loc2_.playUISound("16004");
         }
      }
   }
}
