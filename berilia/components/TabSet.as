package com.ankamagames.berilia.components
{
   ...
   public class TabSet extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      {
         var _loc1_:ButtonContainer = null;
         _loc1_ = new ButtonContainer();
         ...
         var _loc4_:Input;
         (_loc4_ = new Input()).width = this._nWidthLabel;
         ...
         var _loc5_:Array;
         (_loc5_ = new Array())[StatesEnum.STATE_OVER] = new Array();
         ...
         _loc1_.finalize();
         var _loc6_:ButtonContainer;
         (_loc6_ = new ButtonContainer()).x = this._nXCloseTab;
         ...
         var _loc7_:Texture;
         (_loc7_ = new Texture()).uri = this._sCloseTextureUri;
         ...
         var _loc8_:Array;
         (_loc8_ = new Array())[StatesEnum.STATE_OVER] = new Array();
      ...
      private function replaceTab() : void
      {
         ...
         var _loc2_:int = 0;
         for(_loc1_ in this._aCtrs)
         {
            this._aCtrs[_loc1_].state = 0;
            this._aCtrs[_loc1_].x = _loc2_;
            this._aCloses[_loc1_].x = _loc2_ + this._nXCloseTab;
            this._aCtrs[_loc1_].reset();
            _loc2_ = _loc2_ + this._aCtrs[_loc1_].width;
         }
         this._btnPlus.x = _loc2_;
         if(this._nSelected == -1)
         {
            this.selectedTab = _loc1_;
         }
