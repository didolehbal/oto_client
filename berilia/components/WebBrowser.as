   ...
   public class WebBrowser extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         if(param1 is KeyboardKeyDownMessage || param1 is KeyboardKeyUpMessage)
         {
            ...
            if((_loc6_ = BindsManager.getInstance().getBind(new Bind(_loc5_,"",_loc3_.keyboardEvent.altKey,_loc3_.keyboardEvent.ctrlKey,_loc3_.keyboardEvent.shiftKey))) && (_loc6_.targetedShortcut == "closeUi" || _loc6_.targetedShortcut == "toggleFullscreen"))
            {
               _loc4_ = true;
            }
            if(!_loc4_)
