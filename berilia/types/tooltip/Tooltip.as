package com.ankamagames.berilia.types.tooltip
{
   ...
   public class Tooltip
   {
      ...
      {
         var _loc1_:TooltipBlock = null;
         var _loc2_:Array = new Array();
         for each(_loc1_ in this._blocks)
         {
            if(_loc1_.content && _loc1_.content.length)
            {
               _loc2_.push(this._mainblock.getChunk("container").processContent({"content":_loc1_.content}));
            }
         }
