package com.ankamagames.berilia.types.graphic
{
   ...
   public class GraphicContainer extends Sprite implements UIComponent, IRectangle, Poolable, IDragAndDropHandler, ICustomUnicNameGetter
   {
      ...
      override public function set width(param1:Number) : void
      {
         ...
         var _loc3_:UiRootContainer = this.getUi();
         if(_loc3_)
         {
            _loc2_ = _loc3_.getElementById(name);
            if(_loc2_ && _loc3_.ready)
            {
               _loc2_.size.setX(param1,_loc2_.size.xUnit);
            }
            _loc3_.updateLinkedUi();
         }
      }
      ...
      override public function set height(param1:Number) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc2_ && _loc3_.ready)
            {
               _loc2_.size.setY(param1,_loc2_.size.yUnit);
            }
            _loc3_.updateLinkedUi();
         }
      }
      ...
      override public function set x(param1:Number) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc2_ && _loc3_.ready)
            {
               _loc2_.location.setOffsetX(param1);
            }
            _loc3_.updateLinkedUi();
         }
      }
      ...
      override public function set y(param1:Number) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc2_ && _loc3_.ready)
            {
               _loc2_.location.setOffsetY(param1);
            }
            _loc3_.updateLinkedUi();
         }
      }
      ...
      public function get anchorY() : Number
      {
         ...
         if(_loc2_)
         {
            _loc1_ = _loc2_.getElementById(name);
            if(_loc1_ && _loc2_.ready)
            {
               return _loc1_.location.getOffsetY();
            }
         }
         return NaN;
      }
      ...
      public function get anchorX() : Number
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc1_ && _loc2_.ready)
            {
               return _loc1_.location.getOffsetX();
            }
         }
         return NaN;
      }
      ...
      private function defaultDropValidatorFunction(param1:*, param2:*, param3:*) : Boolean
      {
         ...
         while(!((_loc4_ = _loc4_.parent) is IDragAndDropHandler) && _loc4_.parent)
         {
         }
