package com.ankamagames.berilia.api
{
   ...
   public dynamic class ReadOnlyObject extends Proxy implements Secure
   {
      ...
      public static function create(param1:Object) : ReadOnlyObject
      {
         ...
         {
            for(_loc2_ in _readOnlyObjectList)
            {
               if(_loc2_ && _loc2_._object == param1)
               {
                  return _loc2_;
               }
            }
         }
         var _loc3_:ReadOnlyObject = new ReadOnlyObject(param1,SecureCenter.ACCESS_KEY);
         _readOnlyObjectList[_loc3_] = true;
