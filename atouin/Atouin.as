package com.ankamagames.atouin
{
   ...
   public class Atouin
   {
      ...
      public function get selectionContainer() : DisplayObjectContainer
      {
         ...
         var _loc3_:Number = this._spMapContainer.numChildren;
         if(_loc3_ > 1)
         {
            _loc2_ = 1;
            while(!_loc1_ && _loc2_ < _loc3_)
            {
               _loc1_ = this._spMapContainer.getChildAt(_loc2_) as DisplayObjectContainer;
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      public function toggleWorldMask() : void
      {
         this._worldMask.visible = !this._worldMask.visible;
      }
      ...
      public function zoom(param1:Number, param2:int = 0, param3:int = 0) : void
      {
         ...
         var _loc5_:MapZoomMessage = new MapZoomMessage(param1,param2,param3);
