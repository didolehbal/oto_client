package com.ankamagames.dofus.console.moduleLogger
{
   ...
   public final class TextFieldScrollBar extends Sprite
   {
      ...
      private function checkSpan(param1:String, param2:int) : String
      {
         ...
         var _loc7_:int = param1.indexOf("<span");
         var _loc8_:int;
         if((_loc8_ = param1.indexOf("</span>")) < _loc7_)
         {
            _loc3_ = 0;
            while(_loc3_ <= param2)
            {
               if((_loc4_ = this.wordWrapLines[_loc3_].indexOf("<span")) != -1)
               {
                  _loc5_ = this.wordWrapLines[_loc3_].substring(_loc4_,this.wordWrapLines[_loc3_].indexOf(">") + 1);
               }
               _loc3_++;
            }
