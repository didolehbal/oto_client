package com.ankamagames.dofus.console.debug
{
   ...
   public class DtdInstructionHandler implements ConsoleInstructionHandler
   {
      ...
      public function handle(param1:ConsoleHandler, param2:String, param3:Array) : void
      {
         ...
         switch(param2)
         {
            ...
            case "shortcutsdtd":
               ...
               (_loc11_ = new URLLoader()).addEventListener(Event.COMPLETE,this.onXmlLoadComplete);
         ...
         for(_loc18_ in _loc13_)
         {
            ...
            _loc7_.push("Anchors?");
            _loc7_.push("Events?");
            _loc5_ = (_loc5_ = _loc5_ + ("&lt;!ELEMENT " + _loc18_ + " (" + _loc7_.join(" | ") + ")* &gt;\n")) + ("&lt;!ATTLIST " + _loc18_ + "\n" + "\t\tname CDATA #IMPLIED\n" + "\t\tstrata (LOW | MEDIUM | HIGH | TOP | TOOLTIP) #IMPLIED &gt;");
         }
         param1.output(_loc5_);
      }
      ...
      private function parseShortcutXml(param1:String) : void
      {
         ...
         for each(_loc2_ in _loc3_..bind)
         {
            _loc4_ = _loc4_ + ("&lt;!ELEMENT " + _loc2_..@name + " EMPTY &gt;\n");
            _loc5_.push(_loc2_..@name);
         }
         _loc4_ = _loc4_ + ("&lt;!ELEMENT Shortcuts (" + _loc5_.join(" | ") + ")* &gt;");
         if(this._chCurrent != null)
         {
            this._chCurrent.output(_loc4_);
         }
      }
