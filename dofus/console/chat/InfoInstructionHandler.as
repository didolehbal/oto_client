      ...
      public function handle(param1:ConsoleHandler, param2:String, param3:Array) : void
      {
         ...
         switch(param2)
         {
            case "whois":
               ...
               if((_loc4_ = param3.shift()).length >= 1 && _loc4_.length <= ProtocolConstantsEnum.MAX_PLAYER_OR_ACCOUNT_NAME_LEN)
               {
                  (_loc10_ = new BasicWhoIsRequestMessage()).initBasicWhoIsRequestMessage(true,_loc4_);
            ...
            case "about":
               ...
               return;
            case "whoami":
               (_loc5_ = new BasicWhoAmIRequestMessage()).initBasicWhoAmIRequestMessage(true);
