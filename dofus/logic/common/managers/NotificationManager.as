package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class NotificationManager
   {
      ...
      {
         var _loc4_:Notification;
         (_loc4_ = new Notification()).title = param1;
      ...
      {
         var _loc6_:Notification;
         (_loc6_ = new Notification()).title = param1;
      ...
      {
         var _loc9_:Notification;
         (_loc9_ = this.getNotification(param1)).addButton(param2,param3,param4,param5,param6,param7,param8);
      }
      
      public function addCallbackToNotification(param1:uint, param2:String, param3:Object = null, param4:String = "action") : void
      {
         var _loc5_:Notification;
         (_loc5_ = this.getNotification(param1)).callback = param2;
      ...
      {
         var _loc9_:Notification;
         (_loc9_ = this.getNotification(param1)).addImage(param2,param7,param8,param3,param4,param5,param6);
      }
      ...
      {
         var _loc6_:Notification;
         (_loc6_ = this.getNotification(param1)).setTimer(param2,param3,param4,param5);
      }
...
class Notification
{
   ...
   {
      var _loc8_:Object;
      (_loc8_ = new Object()).label = param1;
