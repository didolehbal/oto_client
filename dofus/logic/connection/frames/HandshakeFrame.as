         ...
         switch(true)
         {
            case param1 is ProtocolRequired:
               ...
               if(_loc2_.currentVersion < Metadata.PROTOCOL_REQUIRED_BUILD)
               {
                  ...
                  {
                     (_loc4_ = UiModuleManager.getInstance().getModule("Ankama_Common").mainClass).openPopup(I18n.getUiText("ui.popup.warning"),I18n.getUiText("ui.popup.protocolError",[Metadata.PROTOCOL_BUILD,_loc2_.currentVersion]),[I18n.getUiText("ui.common.ok")]);
                  }
               }
