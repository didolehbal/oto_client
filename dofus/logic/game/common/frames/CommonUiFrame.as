package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class CommonUiFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is OpenMapAction:
               if(!(_loc6_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id)))
               {
                  return true;
               }
            ...
            case param1 is SystemMessageDisplayMessage:
               if((_loc12_ = param1 as SystemMessageDisplayMessage).hangUp)
               {
                  (_loc38_ = new DelayedSystemMessageDisplayMessage()).initDelayedSystemMessageDisplayMessage(_loc12_.hangUp,_loc12_.msgId,_loc12_.parameters);
            ...
            case param1 is ToggleWitnessForbiddenAction:
               ...
               (_loc31_ = new GameFightOptionToggleMessage()).initGameFightOptionToggleMessage(_loc30_);
            ...
            case param1 is ToggleLockPartyAction:
               ...
               (_loc33_ = new GameFightOptionToggleMessage()).initGameFightOptionToggleMessage(_loc32_);
            ...
            case param1 is ToggleLockFightAction:
               ...
               (_loc35_ = new GameFightOptionToggleMessage()).initGameFightOptionToggleMessage(_loc34_);
            ...
            case param1 is ToggleHelpWantedAction:
               ...
               (_loc37_ = new GameFightOptionToggleMessage()).initGameFightOptionToggleMessage(_loc36_);
      ...
      private function systemMessageDisplay(param1:SystemMessageDisplayMessage) : void
      {
         ...
         if(_loc4_ = InfoMessage.getInfoMessageById(40000 + param1.msgId))
         {
            _loc5_ = _loc4_.textId;
            _loc3_ = I18n.getText(_loc5_);
            if(_loc3_)
            {
               _loc3_ = ParamsDecoder.applyParams(_loc3_,_loc7_);
            }
         }
         else
         {
            _log.error("Information message " + (40000 + param1.msgId) + " cannot be found.");
            _loc3_ = "Information message " + (40000 + param1.msgId) + " cannot be found.";
         }
         _loc6_.openPopup(I18n.getUiText("ui.popup.warning"),_loc3_,[I18n.getUiText("ui.common.ok")],null,null,null,null,false,true);
      }
   }
}
