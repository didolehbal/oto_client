      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is KrosmasterInventoryRequestAction:
               ...
               (_loc7_ = new KrosmasterInventoryRequestMessage()).initKrosmasterInventoryRequestMessage();
            ...
            case param1 is KrosmasterTransferRequestAction:
               ...
               (_loc11_ = new KrosmasterTransferRequestMessage()).initKrosmasterTransferRequestMessage(_loc10_.figureId);
            ...
            case param1 is KrosmasterPlayingStatusAction:
               ...
               (_loc14_ = new KrosmasterPlayingStatusMessage()).initKrosmasterPlayingStatusMessage(_loc13_.playing);
            ...
            case param1 is ShopAuthentificationRequestAction:
               ...
               {
                  (_loc20_ = UiModuleManager.getInstance().getModule("Ankama_Common").mainClass).openInputPopup("ICE Authentication","To access the Release shop, please enter a valid ICE Token.\nClose this message to access the Local shop.",this.onTokenInput,this.onCancel);
               }
               else
               {
