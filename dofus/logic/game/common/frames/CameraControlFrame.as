   ...
   public class CameraControlFrame implements Frame
   {
      ...
      private function updateElementsPositions(param1:Event) : void
      {
         ...
         if(this._container.x != this._containerLastX || this._container.y != this._containerLastY)
         {
            ...
            if(_loc4_ = Kernel.getWorker().getFrame(InfoEntitiesFrame) as InfoEntitiesFrame)
            {
               _loc4_.updateAllTooltips();
            }
            if(_loc5_ = LinkedCursorSpriteManager.getInstance().getItem("changeMapCursor"))
            {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is MapZoomMessage:
               ...
               return PlayedCharacterManager.getInstance().isFighting;
         }
         return false;
      }
