      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is MapRunningFightDetailsRequestAction:
               ...
               (_loc6_ = new MapRunningFightDetailsRequestMessage()).initMapRunningFightDetailsRequestMessage(_loc5_.fightId);
               ConnectionsHandler.getConnection().send(_loc6_);
               return true;
            case param1 is StopToListenRunningFightAction:
               (_loc7_ = new StopToListenRunningFightRequestMessage()).initStopToListenRunningFightRequestMessage();
            ...
            case param1 is JoinAsSpectatorRequestAction:
               ...
               (_loc13_ = new GameFightJoinRequestMessage()).initGameFightJoinRequestMessage(0,_loc12_.fightId);
            ...
            case param1 is JoinFightRequestAction:
               ...
               (_loc13_ = new GameFightJoinRequestMessage()).initGameFightJoinRequestMessage(_loc14_.teamLeaderId,_loc14_.fightId);
               ConnectionsHandler.getConnection().send(_loc13_);
               return true;
            case param1 is GameFightSpectatePlayerRequestAction:
               _loc15_ = param1 as GameFightSpectatePlayerRequestAction;
               (_loc16_ = new GameFightSpectatePlayerRequestMessage()).initGameFightSpectatePlayerRequestMessage(_loc15_.playerId);
