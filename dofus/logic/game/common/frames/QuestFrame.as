      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is QuestInfosRequestAction:
               ...
               (_loc5_ = new QuestStepInfoRequestMessage()).initQuestStepInfoRequestMessage(_loc4_.questId);
               ConnectionsHandler.getConnection().send(_loc5_);
               return true;
            case param1 is QuestStepInfoMessage:
               if((_loc6_ = param1 as QuestStepInfoMessage).infos is QuestActiveDetailedInformations)
               {
                  ...
                  for each(_loc68_ in _loc67_.objectives)
                  {
                     ...
                     {
                        (_loc71_ = new Object()).current = (_loc68_ as QuestObjectiveInformationsWithCompletion).curCompletion;
            ...
            case param1 is QuestStartRequestAction:
               ...
               (_loc8_ = new QuestStartRequestMessage()).initQuestStartRequestMessage(_loc7_.questId);
            ...
            case param1 is QuestObjectiveValidationAction:
               ...
               (_loc10_ = new QuestObjectiveValidationMessage()).initQuestObjectiveValidationMessage(_loc9_.questId,_loc9_.objectiveId);
               ConnectionsHandler.getConnection().send(_loc10_);
               return true;
            case param1 is GuidedModeReturnRequestAction:
               (_loc11_ = new GuidedModeReturnRequestMessage()).initGuidedModeReturnRequestMessage();
               ConnectionsHandler.getConnection().send(_loc11_);
               return true;
            case param1 is GuidedModeQuitRequestAction:
               (_loc12_ = new GuidedModeQuitRequestMessage()).initGuidedModeQuitRequestMessage();
            ...
            case param1 is NotificationUpdateFlagAction:
               ...
               (_loc21_ = new NotificationUpdateFlagMessage()).initNotificationUpdateFlagMessage(_loc20_.index);
               ConnectionsHandler.getConnection().send(_loc21_);
               return true;
            case param1 is NotificationResetAction:
               notificationList = new Array();
               (_loc22_ = new NotificationResetMessage()).initNotificationResetMessage();
            ...
            case param1 is AchievementDetailedListRequestAction:
               ...
               (_loc26_ = new AchievementDetailedListRequestMessage()).initAchievementDetailedListRequestMessage(_loc25_.categoryId);
            ...
            case param1 is AchievementDetailsRequestAction:
               ...
               (_loc29_ = new AchievementDetailsRequestMessage()).initAchievementDetailsRequestMessage(_loc28_.achievementId);
            ...
            case param1 is AchievementRewardRequestAction:
               ...
               (_loc37_ = new AchievementRewardRequestMessage()).initAchievementRewardRequestMessage(_loc36_.achievementId);
            ...
            case param1 is TreasureHuntRequestAction:
               ...
               (_loc43_ = new TreasureHuntRequestMessage()).initTreasureHuntRequestMessage(_loc42_.level,_loc42_.questType);
            ...
            case param1 is TreasureHuntLegendaryRequestAction:
               ...
               (_loc45_ = new TreasureHuntLegendaryRequestMessage()).initTreasureHuntLegendaryRequestMessage(_loc44_.legendaryId);
               ConnectionsHandler.getConnection().send(_loc45_);
               return true;
            case param1 is TreasureHuntRequestAnswerMessage:
               if((_loc46_ = param1 as TreasureHuntRequestAnswerMessage).result == TreasureHuntRequestEnum.TREASURE_HUNT_ERROR_ALREADY_HAVE_QUEST)
               {
            ...
            case param1 is TreasureHuntFlagRequestAction:
               ...
               (_loc49_ = new TreasureHuntFlagRequestMessage()).initTreasureHuntFlagRequestMessage(_loc48_.questType,_loc48_.index);
            ...
            case param1 is TreasureHuntFlagRemoveRequestAction:
               ...
               (_loc51_ = new TreasureHuntFlagRemoveRequestMessage()).initTreasureHuntFlagRemoveRequestMessage(_loc50_.questType,_loc50_.index);
            ...
            case param1 is TreasureHuntMessage:
               ...
               {
                  _loc57_++;
                  if((_loc55_ = MapPosition.getMapPositionById(_loc82_.mapId)).worldMap > -1)
                  {
            ...
            case param1 is TreasureHuntGiveUpRequestAction:
               ...
               (_loc61_ = new TreasureHuntGiveUpRequestMessage()).initTreasureHuntGiveUpRequestMessage(_loc60_.questType);
            ...
            case param1 is TreasureHuntDigRequestAction:
               ...
               (_loc63_ = new TreasureHuntDigRequestMessage()).initTreasureHuntDigRequestMessage(_loc62_.questType);
               ConnectionsHandler.getConnection().send(_loc63_);
               return true;
            case param1 is TreasureHuntDigRequestAnswerMessage:
               if((_loc64_ = param1 as TreasureHuntDigRequestAnswerMessage) is TreasureHuntDigRequestAnswerFailedMessage)
               {
