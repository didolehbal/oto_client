package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class BidHouseManagementFrame implements Frame
   {
      ...
      public function processExchangeStartedBidSellerMessage(param1:ExchangeStartedBidSellerMessage) : void
      {
         ...
         var _loc6_:ExchangeStartedBidSellerMessage = param1 as ExchangeStartedBidSellerMessage;
         this._NPCId = _loc6_.sellerDescriptor.npcContextualId;
         this.initSearchMode(_loc6_.sellerDescriptor.types);
         this._vendorObjects = new Array();
         for each(_loc2_ in _loc6_.objectsInfos)
         {
            _loc3_ = ItemWrapper.create(63,_loc2_.objectUID,_loc2_.objectGID,_loc2_.quantity,_loc2_.effects);
            _loc4_ = _loc2_.objectPrice;
            _loc5_ = _loc2_.unsoldDelay;
            this._vendorObjects.push(new ItemSellByPlayer(_loc3_,_loc4_,_loc5_));
         }
         this._vendorObjects.sortOn("unsoldDelay",Array.NUMERIC);
         this._kernelEventsManager.processCallback(ExchangeHookList.ExchangeStartedBidSeller,_loc6_.sellerDescriptor,_loc6_.objectsInfos);
      ...
      public function processExchangeStartedBidBuyerMessage(param1:ExchangeStartedBidBuyerMessage) : void
      {
         var _loc2_:uint = 0;
         this._switching = false;
         var _loc3_:ExchangeStartedBidBuyerMessage = param1 as ExchangeStartedBidBuyerMessage;
         this._NPCId = _loc3_.buyerDescriptor.npcContextualId;
         this.initSearchMode(_loc3_.buyerDescriptor.types);
         this._bidHouseObjects = new Array();
         for each(_loc2_ in _loc3_.buyerDescriptor.types)
         {
            this._bidHouseObjects.push(new TypeObjectData(_loc2_,null));
         }
         this._kernelEventsManager.processCallback(ExchangeHookList.ExchangeStartedBidBuyer,_loc3_.buyerDescriptor);
      }
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is ExchangeBidHouseSearchAction:
               ...
               {
                  (_loc51_ = new ExchangeBidHouseSearchMessage()).initExchangeBidHouseSearchMessage(_loc2_.type,_loc2_.genId);
            ...
            case param1 is ExchangeBidHouseListAction:
               ...
               if(this._GIDAsk != _loc3_.id)
               {
                  ...
                  (_loc52_ = new ExchangeBidHouseListMessage()).initExchangeBidHouseListMessage(_loc3_.id);
                  ConnectionsHandler.getConnection().send(_loc52_);
               }
               else
               {
                  (_loc53_ = new ExchangeBidHouseListMessage()).initExchangeBidHouseListMessage(_loc3_.id);
            ...
            case param1 is ExchangeBidHouseBuyAction:
               ...
               (_loc7_ = new ExchangeBidHouseBuyMessage()).initExchangeBidHouseBuyMessage(_loc6_.uid,_loc6_.qty,_loc6_.price);
            ...
            case param1 is ExchangeBidHousePriceAction:
               ...
               (_loc9_ = new ExchangeBidHousePriceMessage()).initExchangeBidHousePriceMessage(_loc8_.genId);
            ...
            case param1 is ExchangeBidHouseGenericItemAddedMessage:
               ...
               (_loc20_ = this.getTypeObject(this._typeAsk)).objects.push(new GIDObjectData(_loc19_.objGenericId,new Array()));
            ...
            case param1 is ExchangeBidHouseGenericItemRemovedMessage:
               ...
               if((_loc23_ = this.getGIDObjectIndex(this._typeAsk,_loc21_.objGenericId)) == -1)
               {
                  return true;
               }
            ...
            case param1 is ExchangeObjectModifyPricedAction:
               ...
               (_loc25_ = new ExchangeObjectModifyPricedMessage()).initExchangeObjectModifyPricedMessage(_loc24_.objectUID,_loc24_.quantity,_loc24_.price);
            ...
            case param1 is ExchangeBidHouseInListAddedMessage:
               ...
               if(!_loc31_)
               {
                  _loc31_ = _loc63_ = new GIDObjectData(_loc29_.objGenericId,new Array());
            ...
            case param1 is ExchangeTypesExchangerDescriptionForUserMessage:
               ...
               (_loc37_ = this.getTypeObject(this._typeAsk)).objects = new Array();
            ...
            case param1 is ExchangeTypesItemsExchangerDescriptionForUserMessage:
               ...
               if(!(_loc39_ = this.getGIDObject(this._typeAsk,this._GIDAsk)))
               {
               ...
               if(_loc40_ = this.getGIDObject(this._typeAsk,this._GIDAsk))
               {
            ...
            case param1 is BidHouseStringSearchAction:
               _loc43_ = (_loc42_ = param1 as BidHouseStringSearchAction).searchString;
               _loc46_ = getTimer();
               _loc47_ = new Vector.<uint>();
               if(this._listItemsSearchMode == null)
               {
                  this._listItemsSearchMode = new Array();
                  _loc45_ = (_loc78_ = Item.getItems()).length;
                  _loc44_ = 0;
                  while(_loc44_ < _loc45_)
                  {
                     if((_loc79_ = _loc78_[_loc44_]) && this._itemsTypesAllowed.indexOf(_loc79_.typeId) != -1)
                     {
                        if(_loc79_.name)
                        {
               ...
               while(_loc44_ < _loc45_)
               {
                  if((_loc80_ = this._listItemsSearchMode[_loc44_]).indexOf(_loc43_) != -1)
                  {
            ...
            case param1 is BidSwitchToBuyerModeAction:
               ...
               (_loc48_ = new NpcGenericActionRequestMessage()).initNpcGenericActionRequestMessage(this._NPCId,6,PlayedCharacterManager.getInstance().currentMap.mapId);
               ConnectionsHandler.getConnection().send(_loc48_);
               return true;
            case param1 is BidSwitchToSellerModeAction:
               this._switching = true;
               (_loc49_ = new NpcGenericActionRequestMessage()).initNpcGenericActionRequestMessage(this._NPCId,5,PlayedCharacterManager.getInstance().currentMap.mapId);
               ConnectionsHandler.getConnection().send(_loc49_);
               return true;
            case param1 is ExchangeLeaveMessage:
               if((_loc50_ = param1 as ExchangeLeaveMessage).dialogType == DialogTypeEnum.DIALOG_EXCHANGE)
               {
      ...
      {
         var _loc3_:GIDObjectData = null;
         if(this._bidHouseObjects == null)
         {
            return null;
         }
         var _loc4_:TypeObjectData;
         if((_loc4_ = this.getTypeObject(param1)) == null)
         {
            return null;
         }
         for each(_loc3_ in _loc4_.objects)
         {
            if(_loc3_.GIDObject == param2)
            {
               return _loc3_;
            }
         }
