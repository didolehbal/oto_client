package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class SocialFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is AddFriendAction:
               if((_loc10_ = param1 as AddFriendAction).name.length < 2 || _loc10_.name.length > 20)
               {
               ...
               {
                  (_loc163_ = new FriendAddRequestMessage()).initFriendAddRequestMessage(_loc10_.name);
            ...
            case param1 is FriendAddedMessage:
               if((_loc11_ = param1 as FriendAddedMessage).friendAdded is FriendOnlineInformations)
               {
            ...
            case param1 is AddEnemyAction:
               if((_loc15_ = param1 as AddEnemyAction).name.length < ProtocolConstantsEnum.MIN_PLAYER_NAME_LEN || _loc15_.name.length > ProtocolConstantsEnum.MAX_PLAYER_NAME_LEN)
               {
                  _loc14_ = I18n.getUiText("ui.social.friend.addFailureNotFound");
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc14_,ChatFrame.RED_CHANNEL_ID,TimeManager.getInstance().getTimestamp());
               }
               ...
               {
                  (_loc164_ = new IgnoredAddRequestMessage()).initIgnoredAddRequestMessage(_loc15_.name);
            ...
            case param1 is IgnoredAddedMessage:
               if((_loc16_ = param1 as IgnoredAddedMessage).ignoreAdded is IgnoredOnlineInformations)
               {
            ...
            case param1 is RemoveFriendAction:
               ...
               (_loc20_ = new FriendDeleteRequestMessage()).initFriendDeleteRequestMessage(_loc19_.accountId);
            ...
            case param1 is RemoveEnemyAction:
               ...
               (_loc27_ = new IgnoredDeleteRequestMessage()).initIgnoredDeleteRequestMessage(_loc26_.accountId);
               ConnectionsHandler.getConnection().send(_loc27_);
               return true;
            case param1 is IgnoredDeleteResultMessage:
               if(!(_loc28_ = param1 as IgnoredDeleteResultMessage).session)
               {
            ...
            case param1 is AddIgnoredAction:
               if((_loc29_ = param1 as AddIgnoredAction).name.length < ProtocolConstantsEnum.MIN_PLAYER_NAME_LEN || _loc29_.name.length > ProtocolConstantsEnum.MAX_PLAYER_NAME_LEN)
               {
                  _loc14_ = I18n.getUiText("ui.social.friend.addFailureNotFound");
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc14_,ChatFrame.RED_CHANNEL_ID,TimeManager.getInstance().getTimestamp());
               }
               else if(_loc29_.name != PlayedCharacterManager.getInstance().infos.name)
               {
                  ...
                  (_loc172_ = new IgnoredAddRequestMessage()).initIgnoredAddRequestMessage(_loc29_.name,true);
            ...
            case param1 is RemoveIgnoredAction:
               ...
               (_loc31_ = new IgnoredDeleteRequestMessage()).initIgnoredDeleteRequestMessage(_loc30_.accountId,true);
               ConnectionsHandler.getConnection().send(_loc31_);
               return true;
            case param1 is JoinFriendAction:
               _loc32_ = param1 as JoinFriendAction;
               (_loc33_ = new FriendJoinRequestMessage()).initFriendJoinRequestMessage(_loc32_.name);
            ...
            case param1 is FriendSpouseFollowAction:
               ...
               (_loc36_ = new FriendSpouseFollowWithCompassRequestMessage()).initFriendSpouseFollowWithCompassRequestMessage(_loc35_.enable);
            ...
            case param1 is FriendWarningSetAction:
               ...
               (_loc38_ = new FriendSetWarnOnConnectionMessage()).initFriendSetWarnOnConnectionMessage(_loc37_.enable);
            ...
            case param1 is MemberWarningSetAction:
               ...
               (_loc40_ = new GuildMemberSetWarnOnConnectionMessage()).initGuildMemberSetWarnOnConnectionMessage(_loc39_.enable);
            ...
            case param1 is FriendOrGuildMemberLevelUpWarningSetAction:
               ...
               (_loc42_ = new FriendSetWarnOnLevelGainMessage()).initFriendSetWarnOnLevelGainMessage(_loc41_.enable);
            ...
            case param1 is FriendGuildSetWarnOnAchievementCompleteAction:
               ...
               (_loc44_ = new FriendGuildSetWarnOnAchievementCompleteMessage()).initFriendGuildSetWarnOnAchievementCompleteMessage(_loc43_.enable);
            ...
            case param1 is WarnOnHardcoreDeathAction:
               ...
               (_loc46_ = new WarnOnPermaDeathMessage()).initWarnOnPermaDeathMessage(_loc45_.enable);
            ...
            case param1 is GuildInformationsMemberUpdateMessage:
               ...
               if(this._guildMembers != null)
               {
                  ...
                  {
                     if((_loc67_ = this._guildMembers[_loc185_]).id == _loc66_.member.id)
                     {
            ...
            case param1 is TaxCollectorAttackedMessage:
               _loc83_ = (_loc82_ = param1 as TaxCollectorAttackedMessage).worldX;
            ...
            case param1 is TaxCollectorAttackedResultMessage:
               ...
               if((_loc90_ = _loc87_.guild.guildName) == "#NONAME#")
               {
                  _loc90_ = I18n.getUiText("ui.guild.noName");
               }
               _loc92_ = (_loc91_ = new WorldPointWrapper(_loc87_.basicInfos.mapId,true,_loc87_.basicInfos.worldX,_loc87_.basicInfos.worldY)).outdoorX;
            ...
            case param1 is TopTaxCollectorListMessage:
               if((_loc103_ = param1 as TopTaxCollectorListMessage).isDungeon)
               {
            ...
            case param1 is ContactLookMessage:
               if((_loc111_ = param1 as ContactLookMessage).requestId == 0)
               {
            ...
            case param1 is GuildGetInformationsAction:
               ...
               if(_loc114_)
               {
                  (_loc196_ = new GuildGetInformationsMessage()).initGuildGetInformationsMessage(_loc113_.infoType);
            ...
            case param1 is GuildInvitationAction:
               ...
               (_loc116_ = new GuildInvitationMessage()).initGuildInvitationMessage(_loc115_.targetId);
            ...
            case param1 is GuildInvitationByNameAction:
               ...
               (_loc118_ = new GuildInvitationByNameMessage()).initGuildInvitationByNameMessage(_loc117_.target);
            ...
            case param1 is GuildKickRequestAction:
               ...
               (_loc120_ = new GuildKickRequestMessage()).initGuildKickRequestMessage(_loc119_.targetId);
            ...
            case param1 is GuildChangeMemberParametersAction:
               ...
               (_loc123_ = new GuildChangeMemberParametersMessage()).initGuildChangeMemberParametersMessage(_loc121_.memberId,_loc121_.rank,_loc121_.experienceGivenPercent,_loc122_);
            ...
            case param1 is GuildSpellUpgradeRequestAction:
               ...
               (_loc125_ = new GuildSpellUpgradeRequestMessage()).initGuildSpellUpgradeRequestMessage(_loc124_.spellId);
            ...
            case param1 is GuildCharacsUpgradeRequestAction:
               ...
               (_loc127_ = new GuildCharacsUpgradeRequestMessage()).initGuildCharacsUpgradeRequestMessage(_loc126_.charaTypeTarget);
            ...
            case param1 is GuildFarmTeleportRequestAction:
               ...
               (_loc129_ = new GuildPaddockTeleportRequestMessage()).initGuildPaddockTeleportRequestMessage(_loc128_.farmId);
            ...
            case param1 is GuildHouseTeleportRequestAction:
               ...
               (_loc131_ = new GuildHouseTeleportRequestMessage()).initGuildHouseTeleportRequestMessage(_loc130_.houseId);
            ...
            case param1 is GuildFightJoinRequestAction:
               ...
               (_loc133_ = new GuildFightJoinRequestMessage()).initGuildFightJoinRequestMessage(_loc132_.taxCollectorId);
            ...
            case param1 is GuildFightTakePlaceRequestAction:
               ...
               (_loc135_ = new GuildFightTakePlaceRequestMessage()).initGuildFightTakePlaceRequestMessage(_loc134_.taxCollectorId,_loc134_.replacedCharacterId);
            ...
            case param1 is GuildFightLeaveRequestAction:
                     ...
                     if(_loc197_.state == TaxCollectorStateEnum.STATE_WAITING_FOR_HELP)
                     {
                        ...
                        for each(_loc199_ in _loc198_.allyCharactersInformations)
                        {
                           if(_loc199_.playerCharactersInformations.id == _loc136_.characterId)
                           {
                              ...
                              (_loc137_ = new GuildFightLeaveRequestMessage()).initGuildFightLeaveRequestMessage(_loc197_.uniqueId,_loc136_.characterId);
               ...
               {
                  (_loc137_ = new GuildFightLeaveRequestMessage()).initGuildFightLeaveRequestMessage(_loc136_.taxCollectorId,_loc136_.characterId);
                  ConnectionsHandler.getConnection().send(_loc137_);
               }
               return true;
            ...
            case param1 is GuildFactsRequestAction:
               ...
               (_loc139_ = new GuildFactsRequestMessage()).initGuildFactsRequestMessage(_loc138_.guildId);
            ...
            case param1 is GuildFactsMessage:
               ...
               {
                  _loc142_ = (_loc207_ = param1 as GuildInAllianceFactsMessage).allianceInfos.allianceId;
            ...
            case param1 is CharacterReportAction:
               ...
               (_loc147_ = new CharacterReportMessage()).initCharacterReportMessage(_loc146_.reportedId,_loc146_.reason);
            ...
            case param1 is ChatReportAction:
               ...
               _loc151_ = (_loc150_ = Kernel.getWorker().getFrame(ChatFrame) as ChatFrame).getTimestampServerByRealTimestamp(_loc148_.timestamp);
            ...
            case param1 is PlayerStatusUpdateRequestAction:
               if((_loc153_ = param1 as PlayerStatusUpdateRequestAction).message)
               {
               ...
               {
                  (_loc154_ = new PlayerStatus()).initPlayerStatus(_loc153_.status);
               }
               (_loc155_ = new PlayerStatusUpdateRequestMessage()).initPlayerStatusUpdateRequestMessage(_loc154_);
               ConnectionsHandler.getConnection().send(_loc155_);
               return true;
            case param1 is ContactLookRequestByIdAction:
               if((_loc156_ = param1 as ContactLookRequestByIdAction).entityId == PlayedCharacterManager.getInstance().id)
               {
               ...
               {
                  (_loc212_ = new ContactLookRequestByIdMessage()).initContactLookRequestByIdMessage(1,_loc156_.contactType,_loc156_.entityId);
      ...
      {
         var _loc3_:IgnoredWrapper = null;
         var _loc4_:String = AccountManager.getInstance().getAccountName(param1);
         for each(_loc3_ in this._ignoredList)
         {
            if(param2 != 0 && _loc3_.accountId == param2 || _loc4_ && _loc3_.name.toLowerCase() == _loc4_.toLowerCase())
            {
               return true;
            }
         }
      ...
      {
         var _loc2_:FriendWrapper = null;
         var _loc4_:int = 0;
         var _loc3_:int = this._friendsList.length;
         while(_loc4_ < _loc3_)
         {
            _loc2_ = this._friendsList[_loc4_];
      ...
      public function isEnemy(param1:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         var _loc3_:int = this._enemiesList.length;
         while(_loc4_ < _loc3_)
         {
            _loc2_ = this._enemiesList[_loc4_];
            if(_loc2_.playerName == param1)
            {
               return true;
            }
