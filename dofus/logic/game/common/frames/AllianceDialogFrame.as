      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is AllianceModificationValidAction:
               ...
               (_loc5_ = new AllianceModificationValidMessage()).initAllianceModificationValidMessage(_loc4_.name,_loc4_.tag,this.allianceEmblem);
            ...
            case param1 is AllianceModificationNameAndTagValidAction:
               ...
               (_loc7_ = new AllianceModificationNameAndTagValidMessage()).initAllianceModificationNameAndTagValidMessage(_loc6_.name,_loc6_.tag);
            ...
            case param1 is AllianceModificationEmblemValidAction:
               ...
               (_loc9_ = new AllianceModificationEmblemValidMessage()).initAllianceModificationEmblemValidMessage(this.allianceEmblem);
            ...
            case param1 is AllianceInvitationAnswerAction:
               ...
               (_loc11_ = new AllianceInvitationAnswerMessage()).initAllianceInvitationAnswerMessage(_loc10_.accept);
               ConnectionsHandler.getConnection().send(_loc11_);
               this.leaveDialog();
               return true;
            case param1 is LeaveDialogMessage:
               if((_loc12_ = param1 as LeaveDialogMessage).dialogType == DialogTypeEnum.DIALOG_ALLIANCE_CREATE || _loc12_.dialogType == DialogTypeEnum.DIALOG_ALLIANCE_INVITATION || _loc12_.dialogType == DialogTypeEnum.DIALOG_ALLIANCE_RENAME)
               {
                  this.leaveDialog();
               }
               return true;
