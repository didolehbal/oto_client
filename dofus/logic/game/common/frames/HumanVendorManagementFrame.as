      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is ExchangeObjectModifyPricedAction:
               ...
               (_loc7_ = new ExchangeObjectModifyPricedMessage()).initExchangeObjectModifyPricedMessage(_loc6_.objectUID,_loc6_.quantity,_loc6_.price);
            ...
            case param1 is ExchangeLeaveMessage:
               if((_loc15_ = param1 as ExchangeLeaveMessage).dialogType == DialogTypeEnum.DIALOG_EXCHANGE)
               {
