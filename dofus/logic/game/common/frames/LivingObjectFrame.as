      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is LivingObjectFeedAction:
               ...
               (_loc5_ = new ObjectFeedMessage()).initObjectFeedMessage(_loc4_.objectUID,_loc4_.foodUID,_loc4_.foodQuantity);
            ...
            case param1 is LivingObjectChangeSkinRequestAction:
               ...
               (_loc7_ = new LivingObjectChangeSkinRequestMessage()).initLivingObjectChangeSkinRequestMessage(_loc6_.livingUID,_loc6_.livingPosition,_loc6_.skinId);
            ...
            case param1 is ObjectModifiedMessage:
               ...
               if(!(_loc9_ = ItemWrapper.create(_loc8_.object.position,_loc8_.object.objectUID,_loc8_.object.objectGID,_loc8_.object.quantity,_loc8_.object.effects,false)))
               {
                  return false;
               }
            ...
            case param1 is MimicryObjectFeedAndAssociateRequestAction:
               ...
               (_loc11_ = new MimicryObjectFeedAndAssociateRequestMessage()).initMimicryObjectFeedAndAssociateRequestMessage(_loc10_.mimicryUID,_loc10_.symbiotePos,_loc10_.hostUID,_loc10_.hostPos,_loc10_.foodUID,_loc10_.foodPos,_loc10_.preview);
            ...
            case param1 is MimicryObjectPreviewMessage:
               ...
               if(!(_loc13_ = ItemWrapper.create(_loc12_.result.position,_loc12_.result.objectUID,_loc12_.result.objectGID,_loc12_.result.quantity,_loc12_.result.effects,false)))
               {
                  return false;
               }
            ...
            case param1 is MimicryObjectErrorMessage:
               if((_loc14_ = param1 as MimicryObjectErrorMessage).reason == ObjectErrorEnum.SYMBIOTIC_OBJECT_ERROR)
               {
            ...
            case param1 is MimicryObjectEraseRequestAction:
               ...
               (_loc18_ = new MimicryObjectEraseRequestMessage()).initMimicryObjectEraseRequestMessage(_loc17_.hostUID,_loc17_.hostPos);
               ConnectionsHandler.getConnection().send(_loc18_);
               return true;
            case param1 is WrapperObjectErrorMessage:
               if((_loc19_ = param1 as WrapperObjectErrorMessage).reason == ObjectErrorEnum.SYMBIOTIC_OBJECT_ERROR)
               {
            ...
            case param1 is WrapperObjectDissociateRequestAction:
               ...
               (_loc23_ = new WrapperObjectDissociateRequestMessage()).initWrapperObjectDissociateRequestMessage(_loc22_.hostUID,_loc22_.hostPosition);
