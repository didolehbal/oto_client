package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class ChatFrame implements Frame
   {
      ...
      public function pushed() : Boolean
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:SmileyWrapper = null;
         var _loc10_:Date = null;
         var _loc11_:Array = null;
         var _loc12_:MoodSmileyRequestAction = null;
         ...
         for each(_loc2_ in Smiley.getSmileys())
         {
            ...
            {
               _loc9_ = SmileyWrapper.create(_loc2_.id,_loc2_.gfxId,_loc2_.order);
               this._aSmilies.push(_loc9_);
            }
         }
         ...
         var _loc13_:String;
         if((_loc13_ = _loc7_["moodSmiley_" + _loc8_]) && _loc13_ != "")
         {
            _loc10_ = new Date();
            _loc11_ = _loc13_.split("_");
            if(int(_loc11_[0]) > 0 && Number(_loc11_[1]) < _loc10_.time + 604800000)
            {
               (_loc12_ = new MoodSmileyRequestAction()).smileyId = int(_loc11_[0]);
               this.process(_loc12_);
            }
         }
         return true;
      }
      ...
      private function onCssLoaded() : void
      {
         ...
         while(_loc3_ < 13)
         {
            _loc1_ = _loc2_.getStyle("p" + _loc3_);
            this._aChatColors[_loc3_] = uint(this.color0x(_loc1_["color"]));
            _loc3_++;
         }
         _loc1_ = _loc2_.getStyle("p");
         this._aChatColors.push(uint(this.color0x(_loc1_["color"])));
      }
      ...
      private function saveMessage(param1:int = 0, param2:String = "", param3:String = "", param4:Number = 0, param5:String = "", param6:uint = 0, param7:String = "", param8:Vector.<ItemWrapper> = null, param9:String = "", param10:uint = 0, param11:uint = 0, param12:Array = null, param13:Boolean = false) : void
      {
         ...
         {
            _loc15_ = this._aMessagesByChannel[param1].length - this._maxMessagesStored;
            _loc16_ = 0;
         ...
         ++this._msgUId;
         KernelEventsManager.getInstance().processCallback(ChatHookList.NewMessage,param1,_loc17_);
      }
      ...
      public function checkCensored(param1:String, param2:uint, param3:uint, param4:String) : Array
      {
         ...
         var _loc26_:String = param1;
         if(OptionManager.getOptionManager("chat").filterInsult && param2 != 8 && param2 != 10 && param2 != 11 && param2 != 666)
         {
            _loc8_ = XmlConfig.getInstance().getEntry("config.lang.current");
            _loc9_ = "";
            _loc10_ = ["&","%","?","#","§","!"];
            if(!(_loc11_ = _loc8_ == "ja"))
            {
               _loc12_ = _loc26_.split(" ");
               for each(_loc13_ in _loc12_)
               {
                  _loc14_ = _loc13_.toLowerCase();
                  _loc15_ = "";
                  if(this._aCensoredWords)
                  {
                     if(this._aCensoredWords[_loc14_])
                     {
                        _loc16_ = 0;
                        while(_loc16_ < _loc14_.length)
                        {
                           _loc15_ = _loc15_ + _loc10_[_loc14_.charCodeAt(_loc16_) % 5];
                           _loc16_++;
                        }
                     }
                     else
                     {
                        for(_loc17_ in this._aCensoredWords)
                        {
                           if(this._aCensoredWords[_loc17_] == 2)
                           {
                              if(_loc14_.indexOf(_loc17_) != -1)
                              {
                                 _loc18_ = 0;
                                 while(_loc18_ < _loc14_.length)
                                 {
                                    _loc15_ = _loc15_ + _loc10_[_loc14_.charCodeAt(_loc18_) % 5];
                                    _loc18_++;
                                 }
                              }
                           }
               ...
               _loc26_ = _loc9_.slice(0,_loc9_.length - 1);
            }
            else
            {
               _loc19_ = "&%?§!&?&%§!&%!&%?#§!";
               _loc20_ = _loc26_.toUpperCase();
               for(_loc21_ in this._aCensoredWords)
               {
                  _loc22_ = 0;
                  while(_loc22_ != -1)
                  {
                     if((_loc22_ = _loc20_.indexOf(_loc21_)) != -1)
                     {
                        _loc20_ = (_loc26_ = _loc26_.substr(0,_loc22_) + _loc19_.substr(0,_loc21_.length) + _loc26_.substr(_loc22_ + _loc21_.length)).toUpperCase();
                     }
                  }
               }
            }
         }
         var _loc27_:Array = _loc26_.split(" ");
         var _loc28_:* = "";
         var _loc30_:* = "";
         var _loc31_:* = "";
         var _loc32_:* = "";
         for each(_loc5_ in _loc27_)
         {
            _loc23_ = "";
            if((_loc24_ = this.needToFormateUrl(_loc5_)).formate)
            {
               _loc23_ = _loc23_ + HtmlManager.addLink("[" + _loc24_.url + "]","event:chatLinkRelease," + _loc24_.url + "," + param3 + "," + param4,{"bold":true});
               _loc29_ = true;
            }
            if(_loc23_ == "")
            {
            ...
            _loc28_ = _loc28_ + (_loc23_ + " ");
         }
         _loc26_ = _loc28_.slice(0,_loc28_.length - 1);
         _loc6_ = 0;
         _loc7_ = new Array();
         if(_loc6_ > 0)
         {
            _loc25_ = I18n.getUiText("ui.popup.warning");
            _loc7_[0] = _loc26_ + " [" + HtmlManager.addLink(I18n.getUiText("ui.popup.warning"),"event:chatWarning",{"color":XmlConfig.getInstance().getEntry("colors.hyperlink.warning")}) + "]";
            _loc7_[1] = _loc26_ + " [" + _loc25_ + "]";
         }
         else
         {
            _loc7_[0] = _loc26_;
      ...
      public function needToFormateUrl(param1:String) : Object
      {
         ...
         var _loc4_:RegExp;
         var _loc5_:Object = (_loc4_ = new RegExp(URL_MATCHER)).exec(_loc2_);
         var _loc6_:Object;
         (_loc6_ = new Object()).formate = false;
         if(_loc5_)
         {
            if(_loc3_)
            {
