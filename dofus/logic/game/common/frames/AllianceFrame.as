package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class AllianceFrame implements Frame
   {
      ...
      {
         var _loc3_:PrismFightersWrapper = null;
         var _loc4_:uint = 0;
         var _loc5_:Boolean = false;
         for each(_loc3_ in param1)
         {
            if(_loc3_.playerCharactersInformations.id == param2)
            {
               _loc5_ = true;
               break;
            }
         ...
         return param1.splice(_loc4_,1)[0];
      }
         ...
         switch(true)
         {
            case param1 is CurrentMapMessage:
               ...
               if(PlayedCharacterManager.getInstance().currentSubArea && _loc4_.id != _loc3_.id)
               {
                  ...
                  {
                     if((_loc90_ = PrismSubAreaWrapper.prismList[_loc4_.id]).state == PrismStateEnum.PRISM_STATE_VULNERABLE)
                     {
                  ...
                  if(PrismSubAreaWrapper.prismList[_loc3_.id] && !PrismSubAreaWrapper.prismList[_loc4_.id])
                  {
                     if((_loc91_ = PrismSubAreaWrapper.prismList[_loc3_.id]).state == PrismStateEnum.PRISM_STATE_VULNERABLE)
                     {
            ...
            case param1 is SetEnableAVARequestAction:
               ...
               (_loc6_ = new SetEnableAVARequestMessage()).initSetEnableAVARequestMessage(_loc5_.enable);
            ...
            case param1 is AllianceInvitationAction:
               ...
               (_loc18_ = new AllianceInvitationMessage()).initAllianceInvitationMessage(_loc17_.targetId);
            ...
            case param1 is AllianceKickRequestAction:
               ...
               (_loc25_ = new AllianceKickRequestMessage()).initAllianceKickRequestMessage(_loc24_.guildId);
            ...
            case param1 is AllianceLeftMessage:
               ...
               this._alliance = null;
               if(_loc27_ = Kernel.getWorker().getFrame(RoleplayEntitiesFrame) as RoleplayEntitiesFrame)
               {
                  for each(_loc93_ in _loc27_.playersId)
                  {
                     _loc27_.removeIconsCategory(_loc93_,EntityIconEnum.AVA_CATEGORY);
                  }
                  (_loc94_ = new UpdateSelfAgressableStatusMessage()).initUpdateSelfAgressableStatusMessage(AggressableStatusEnum.NON_AGGRESSABLE);
            ...
            case param1 is AllianceFactsRequestAction:
               ...
               (_loc29_ = new AllianceFactsRequestMessage()).initAllianceFactsRequestMessage(_loc28_.allianceId);
            ...
            case param1 is AllianceFactsMessage:
               ...
               {
                  if(_loc33_ = _loc35_.getGuildById(_loc95_.guildId))
                  {
            ...
            case param1 is AllianceChangeGuildRightsAction:
               ...
               (_loc38_ = new AllianceChangeGuildRightsMessage()).initAllianceChangeGuildRightsMessage(_loc37_.guildId,_loc37_.rights);
            ...
            case param1 is AllianceInsiderInfoRequestAction:
               ...
               (_loc40_ = new AllianceInsiderInfoRequestMessage()).initAllianceInsiderInfoRequestMessage();
            ...
            case param1 is AllianceInsiderInfoMessage:
               ...
               {
                  if(_loc43_ = _loc47_.getGuildById(_loc96_.guildId))
                  {
               ...
               (_loc48_ = new PrismsListUpdateMessage()).initPrismsListUpdateMessage(_loc41_.prisms);
            ...
            case param1 is PrismSettingsRequestAction:
               ...
               (_loc50_ = new PrismSettingsRequestMessage()).initPrismSettingsRequestMessage(_loc49_.subAreaId,_loc49_.startDefenseTime);
            ...
            case param1 is PrismFightSwapRequestAction:
               ...
               (_loc56_ = new PrismFightSwapRequestMessage()).initPrismFightSwapRequestMessage(_loc55_.subAreaId,_loc55_.targetId);
            ...
            case param1 is PrismInfoJoinLeaveRequestAction:
               ...
               (_loc58_ = new PrismInfoJoinLeaveRequestMessage()).initPrismInfoJoinLeaveRequestMessage(_loc57_.join);
            ...
            case param1 is PrismsListRegisterAction:
               ...
               if((_loc62_ = _loc59_.listen) != PrismListenEnum.PRISM_LISTEN_NONE)
               {
               ...
               if(_loc60_)
               {
                  (_loc101_ = new PrismsListRegisterMessage()).initPrismsListRegisterMessage(_loc62_);
            ...
            case param1 is PrismAttackRequestAction:
               ...
               (_loc64_ = new PrismAttackRequestMessage()).initPrismAttackRequestMessage();
               ConnectionsHandler.getConnection().send(_loc64_);
               return true;
            case param1 is PrismUseRequestAction:
               _loc65_ = param1 as PrismUseRequestAction;
               (_loc66_ = new PrismUseRequestMessage()).initPrismUseRequestMessage();
            ...
            case param1 is PrismModuleExchangeRequestAction:
               ...
               (_loc68_ = new PrismModuleExchangeRequestMessage()).initPrismModuleExchangeRequestMessage();
            ...
            case param1 is PrismSetSabotagedRequestAction:
               ...
               (_loc70_ = new PrismSetSabotagedRequestMessage()).initPrismSetSabotagedRequestMessage(_loc69_.subAreaId);
            ...
            case param1 is PrismsListUpdateMessage:
               ...
               for each(_loc103_ in _loc77_.prisms)
               {
                  ...
                  {
                     _loc82_ = (_loc81_ = _loc103_ as PrismGeolocalizedInformation).prism as AllianceInsiderPrismInformation;
            ...
            case param1 is PrismsListMessage:
               ...
               {
                  if((_loc110_ = PrismSubAreaWrapper.getFromNetwork(_loc84_.prisms[_loc109_],this._alliance)).alliance)
                  {
