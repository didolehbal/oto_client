package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class ExchangeManagementFrame implements Frame
   {
      ...
      {
         var _loc2_:SocialFrame = null;
         var _loc3_:LeaveDialogAction = null;
         ...
         var _loc4_:String = this._sourceInformations.name;
         var _loc5_:String = this._targetInformations.name;
         if(param1.source == PlayedCharacterManager.getInstance().id)
         {
            this._kernelEventsManager.processCallback(ExchangeHookList.ExchangeRequestCharacterFromMe,_loc4_,_loc5_);
         }
         else
         {
            _loc2_ = Kernel.getWorker().getFrame(SocialFrame) as SocialFrame;
            if(_loc2_ && _loc2_.isIgnored(_loc4_))
            {
               _loc3_ = new LeaveDialogAction();
               Kernel.getWorker().process(_loc3_);
               return;
            }
            this._kernelEventsManager.processCallback(ExchangeHookList.ExchangeRequestCharacterToMe,_loc5_,_loc4_);
         }
      }
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is ExchangeStartedWithStorageMessage:
               ...
               PlayedCharacterManager.getInstance().isInExchange = true;
               if(_loc5_ = Kernel.getWorker().getFrame(CommonExchangeManagementFrame) as CommonExchangeManagementFrame)
               {
            ...
            case param1 is ExchangeStartedMessage:
               ...
               PlayedCharacterManager.getInstance().isInExchange = true;
               if(_loc8_ = Kernel.getWorker().getFrame(CommonExchangeManagementFrame) as CommonExchangeManagementFrame)
               {
            ...
            case param1 is StorageObjectUpdateMessage:
               _loc11_ = (_loc10_ = param1 as StorageObjectUpdateMessage).object;
            ...
            case param1 is StorageObjectsUpdateMessage:
               ...
               for each(_loc46_ in _loc14_.objectList)
               {
                  _loc47_ = _loc46_;
            ...
            case param1 is ExchangeObjectMoveKamaAction:
               ...
               (_loc18_ = new ExchangeObjectMoveKamaMessage()).initExchangeObjectMoveKamaMessage(_loc17_.kamas);
            ...
            case param1 is ExchangeObjectTransfertAllToInvAction:
               ...
               (_loc20_ = new ExchangeObjectTransfertAllToInvMessage()).initExchangeObjectTransfertAllToInvMessage();
               ConnectionsHandler.getConnection().send(_loc20_);
               return true;
            case param1 is ExchangeObjectTransfertListToInvAction:
               if((_loc21_ = param1 as ExchangeObjectTransfertListToInvAction).ids.length > ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT)
               {
               ...
               {
                  (_loc50_ = new ExchangeObjectTransfertListToInvMessage()).initExchangeObjectTransfertListToInvMessage(_loc21_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT));
                  ConnectionsHandler.getConnection().send(_loc50_);
               }
               return true;
            case param1 is ExchangeObjectTransfertListWithQuantityToInvAction:
               if((_loc22_ = param1 as ExchangeObjectTransfertListWithQuantityToInvAction).ids.length > ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT / 2)
               {
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,I18n.getUiText("ui.exchange.partialTransfert"),ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO,TimeManager.getInstance().getTimestamp());
               }
               if(_loc22_.ids.length >= ProtocolConstantsEnum.MIN_OBJ_COUNT_BY_XFERT && _loc22_.ids.length == _loc22_.qtys.length)
               {
                  (_loc51_ = new ExchangeObjectTransfertListWithQuantityToInvMessage()).initExchangeObjectTransfertListWithQuantityToInvMessage(_loc22_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT / 2),_loc22_.qtys.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT / 2));
            ...
            case param1 is ExchangeObjectTransfertExistingToInvAction:
               ...
               (_loc24_ = new ExchangeObjectTransfertExistingToInvMessage()).initExchangeObjectTransfertExistingToInvMessage();
            ...
            case param1 is ExchangeObjectTransfertAllFromInvAction:
               ...
               (_loc26_ = new ExchangeObjectTransfertAllFromInvMessage()).initExchangeObjectTransfertAllFromInvMessage();
               ConnectionsHandler.getConnection().send(_loc26_);
               return true;
            case param1 is ExchangeObjectTransfertListFromInvAction:
               if((_loc27_ = param1 as ExchangeObjectTransfertListFromInvAction).ids.length > ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT)
               {
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,I18n.getUiText("ui.exchange.partialTransfert"),ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO,TimeManager.getInstance().getTimestamp());
               }
               if(_loc27_.ids.length >= ProtocolConstantsEnum.MIN_OBJ_COUNT_BY_XFERT)
               {
                  (_loc52_ = new ExchangeObjectTransfertListFromInvMessage()).initExchangeObjectTransfertListFromInvMessage(_loc27_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT));
            ...
            case param1 is ExchangeObjectTransfertExistingFromInvAction:
               ...
               (_loc29_ = new ExchangeObjectTransfertExistingFromInvMessage()).initExchangeObjectTransfertExistingFromInvMessage();
            ...
            case param1 is ExchangeLeaveMessage:
               if((_loc35_ = param1 as ExchangeLeaveMessage).dialogType == DialogTypeEnum.DIALOG_EXCHANGE)
               {
