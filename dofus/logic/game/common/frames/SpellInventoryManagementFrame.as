      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is SlaveSwitchContextMessage:
               _loc7_ = (_loc6_ = param1 as SlaveSwitchContextMessage).slaveId;
               ...
               if(_loc8_ = this._spellsGlobalCooldowns[_loc7_])
               {
                  for each(_loc14_ in _loc8_)
                  {
                     ...
                     if(_loc20_)
                     {
                        ...
                        (_loc19_ = _loc18_.getSpellManagerBySpellId(_loc14_.spellId)).forceCooldown(_loc17_);
                     }
                  }
                  _loc8_.length = 0;
