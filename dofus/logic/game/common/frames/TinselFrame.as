      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is TitleSelectRequestAction:
               ...
               (_loc11_ = new TitleSelectRequestMessage()).initTitleSelectRequestMessage(_loc10_.titleId);
            ...
            case param1 is OrnamentSelectRequestAction:
               ...
               (_loc15_ = new OrnamentSelectRequestMessage()).initOrnamentSelectRequestMessage(_loc14_.ornamentId);
