      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is JobCrafterDirectoryEntryRequestAction:
               ...
               (_loc5_ = new JobCrafterDirectoryEntryRequestMessage()).initJobCrafterDirectoryEntryRequestMessage(_loc4_.playerId);
               ConnectionsHandler.getConnection().send(_loc5_);
               return true;
            case param1 is JobCrafterContactLookRequestAction:
               if((_loc6_ = param1 as JobCrafterContactLookRequestAction).crafterId == PlayedCharacterManager.getInstance().id)
               {
               ...
               {
                  (_loc11_ = new ContactLookRequestByIdMessage()).initContactLookRequestByIdMessage(0,SocialContactCategoryEnum.SOCIAL_CONTACT_CRAFTER,_loc6_.crafterId);
            ...
            case param1 is JobCrafterDirectoryRemoveMessage:
               ...
               {
                  if((_loc14_ = this._crafterList[_loc13_]).jobId == _loc8_.jobId && _loc14_.playerId == _loc8_.playerId)
                  {
            ...
            case param1 is ExchangeLeaveMessage:
               if((_loc10_ = param1 as ExchangeLeaveMessage).dialogType == DialogTypeEnum.DIALOG_EXCHANGE)
               {
