      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is ExchangeAcceptAction:
               (_loc4_ = new ExchangeAcceptMessage()).initExchangeAcceptMessage();
            ...
            case param1 is ExchangeReadyAction:
               ...
               (_loc7_ = new ExchangeReadyMessage()).initExchangeReadyMessage(_loc6_.isReady,this._numCurrentSequence);
            ...
            case param1 is ExchangeObjectsModifiedMessage:
               ...
               _loc11_ = new Array();
               var _loc31_:int = 0;
               var _loc32_:* = _loc10_.object;
               for(; §§hasnext(_loc32_,_loc31_); _loc11_.push(_loc28_))
               {
                  _loc27_ = §§nextvalue(_loc31_,_loc32_);
            ...
            case param1 is ExchangeObjectsAddedMessage:
               ...
               _loc15_ = new Array();
               _loc31_ = 0;
               _loc32_ = _loc14_.object;
               for(; §§hasnext(_loc32_,_loc31_); _loc15_.push(_loc30_))
               {
                  _loc29_ = §§nextvalue(_loc31_,_loc32_);
            ...
            case param1 is ExchangeObjectsRemovedMessage:
               ...
               _loc18_ = new Array();
               _loc31_ = 0;
               _loc32_ = _loc17_.objectUID;
               for(; §§hasnext(_loc32_,_loc31_); _loc18_.push(_loc19_))
               {
                  _loc19_ = §§nextvalue(_loc31_,_loc32_);
                  switch(this._exchangeType)
                  {
                     case ExchangeTypeEnum.CRAFT:
            ...
            case param1 is ExchangeObjectMoveAction:
               ...
               if(!(_loc21_ = InventoryManager.getInstance().inventory.getItem(_loc20_.objectUID)))
               {
               ...
               (_loc22_ = new ExchangeObjectMoveMessage()).initExchangeObjectMoveMessage(_loc20_.objectUID,_loc20_.quantity);
            ...
            case param1 is ExchangeIsReadyMessage:
               ...
               _loc25_ = ((_loc24_ = Kernel.getWorker().getFrame(RoleplayEntitiesFrame) as RoleplayEntitiesFrame).getEntityInfos(_loc23_.id) as GameRolePlayNamedActorInformations).name;
