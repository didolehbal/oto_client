      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is MountInformationInPaddockRequestAction:
               ...
               (_loc6_ = new MountInformationInPaddockRequestMessage()).initMountInformationInPaddockRequestMessage(_loc5_.mountId);
               ConnectionsHandler.getConnection().send(_loc6_);
               return true;
            case param1 is MountToggleRidingRequestAction:
               if((_loc7_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id) as IMovable) && !_loc7_.isMoving)
               {
                  (_loc44_ = new MountToggleRidingRequestMessage()).initMountToggleRidingRequestMessage();
            ...
            case param1 is MountFeedRequestAction:
               ...
               {
                  (_loc45_ = new MountFeedRequestMessage()).initMountFeedRequestMessage(_loc8_.mountId,_loc8_.mountLocation,_loc8_.mountFoodUid,_loc8_.quantity);
                  ConnectionsHandler.getConnection().send(_loc45_);
               }
               return true;
            case param1 is MountReleaseRequestAction:
               (_loc9_ = new MountReleaseRequestMessage()).initMountReleaseRequestMessage();
               ConnectionsHandler.getConnection().send(_loc9_);
               return true;
            case param1 is MountSterilizeRequestAction:
               (_loc10_ = new MountSterilizeRequestMessage()).initMountSterilizeRequestMessage();
            ...
            case param1 is MountRenameRequestAction:
               ...
               (_loc12_ = new MountRenameRequestMessage()).initMountRenameRequestMessage(!!_loc11_.newName?_loc11_.newName:"",_loc11_.mountId);
            ...
            case param1 is MountSetXpRatioRequestAction:
               ...
               (_loc14_ = new MountSetXpRatioRequestMessage()).initMountSetXpRatioRequestMessage(_loc13_.xpRatio > MAX_XP_RATIO?uint(MAX_XP_RATIO):uint(_loc13_.xpRatio));
            ...
            case param1 is MountInfoRequestAction:
               ...
               (_loc16_ = new MountInformationRequestMessage()).initMountInformationRequestMessage(_loc15_.mountId,_loc15_.time);
               ConnectionsHandler.getConnection().send(_loc16_);
               return true;
            case param1 is ExchangeRequestOnMountStockAction:
               (_loc17_ = new ExchangeRequestOnMountStockMessage()).initExchangeRequestOnMountStockMessage();
            ...
            case param1 is MountRenamedMessage:
               _loc19_ = (_loc18_ = param1 as MountRenamedMessage).mountId;
            ...
            case param1 is ExchangeHandleMountStableAction:
               ...
               if((_loc22_ = Vector.<uint>(_loc21_.ridesId)).length > 0)
               {
                  (_loc46_ = new ExchangeHandleMountsStableMessage()).initExchangeHandleMountsStableMessage(_loc21_.actionType,_loc22_);
            ...
            case param1 is MountEmoteIconUsedOkMessage:
               ...
               if(_loc40_ = DofusEntities.getEntity(_loc39_.mountId) as TiphonSprite)
               {
                  _loc53_ = null;
                  ...
                  if(_loc53_)
                  {
                     (_loc54_ = new SerialSequencer()).addStep(new PlayAnimationStep(_loc40_,_loc53_,false));
