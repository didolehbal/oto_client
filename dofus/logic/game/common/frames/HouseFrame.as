package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class HouseFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is LeaveDialogAction:
               ...
               (_loc5_ = new LeaveDialogRequestMessage()).initLeaveDialogRequestMessage();
               ConnectionsHandler.getConnection().send(_loc5_);
               return true;
            case param1 is HouseBuyAction:
               _loc6_ = param1 as HouseBuyAction;
               (_loc7_ = new HouseBuyRequestMessage()).initHouseBuyRequestMessage(_loc6_.proposedPrice);
               ConnectionsHandler.getConnection().send(_loc7_);
               return true;
            case param1 is HouseSellAction:
               _loc8_ = param1 as HouseSellAction;
               (_loc9_ = new HouseSellRequestMessage()).initHouseSellRequestMessage(_loc8_.amount);
            ...
            case param1 is HouseSellFromInsideAction:
               ...
               (_loc11_ = new HouseSellFromInsideRequestMessage()).initHouseSellFromInsideRequestMessage(_loc10_.amount);
            ...
            case param1 is PurchasableDialogMessage:
               ...
               if(_loc16_ = this.getHouseInformations(_loc12_.purchasableId))
               {
            ...
            case param1 is HouseGuildRightsMessage:
               _loc18_ = (_loc17_ = param1 as HouseGuildRightsMessage).guildInfo.guildEmblem;
            ...
            case param1 is HouseGuildShareAction:
               ...
               (_loc27_ = new HouseGuildShareRequestMessage()).initHouseGuildShareRequestMessage(_loc26_.enabled,_loc26_.rights);
               ConnectionsHandler.getConnection().send(_loc27_);
               return true;
            case param1 is HouseKickAction:
               _loc28_ = param1 as HouseKickAction;
               (_loc29_ = new HouseKickRequestMessage()).initHouseKickRequestMessage(_loc28_.id);
            ...
            case param1 is HouseKickIndoorMerchantAction:
               ...
               (_loc31_ = new HouseKickIndoorMerchantRequestMessage()).initHouseKickIndoorMerchantRequestMessage(_loc30_.cellId);
            ...
            case param1 is LockableChangeCodeAction:
               ...
               (_loc35_ = new LockableChangeCodeMessage()).initLockableChangeCodeMessage(_loc34_.code);
            ...
            case param1 is HouseLockFromInsideAction:
               ...
               (_loc37_ = new HouseLockFromInsideRequestMessage()).initHouseLockFromInsideRequestMessage(_loc36_.code);
      ...
      {
         var _loc2_:HouseWrapper = null;
         var _loc3_:Dictionary = (Kernel.getWorker().getFrame(RoleplayEntitiesFrame) as RoleplayEntitiesFrame).housesInformations;
         for each(_loc2_ in _loc3_)
         {
            if(_loc2_.houseId == param1)
            {
               return _loc2_;
            }
         }
