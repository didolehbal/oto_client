package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class StorageOptionManager
   {
      ...
      public function enableCraftFilter(param1:Skill, param2:int) : void
      {
         ...
         var _loc4_:String = this.currentStorageView.name;
         this.inventory.addView(new StorageCraftFilterView(this.inventory.hookLock,this.currentStorageView,param1.id,param2));
         InventoryManager.getInstance().inventory.refillView(_loc4_,"storageCraftFilter");
      }
      ...
      {
         var _loc1_:StorageBidHouseFilterView = null;
         var _loc2_:StorageSmithMagicFilterView = null;
         var _loc3_:StorageCraftFilterView = null;
         var _loc4_:IStorageView = this.getStorageViewOrFilter();
         if(this.getIsBidHouseFilterEnabled())
         {
            _loc1_ = this.inventory.getView("storageBidHouseFilter") as StorageBidHouseFilterView;
            _loc1_.parent = _loc4_;
            this.refreshView("storageBidHouseFilter");
         }
         if(this.getIsSmithMagicFilterEnabled())
         {
            _loc2_ = this.inventory.getView("storageSmithMagicFilter") as StorageSmithMagicFilterView;
            _loc2_.parent = _loc4_;
            this.refreshView("storageSmithMagicFilter");
         }
         if(this.getIsCraftFilterEnabled())
         {
            _loc3_ = this.inventory.getView("storageCraftFilter") as StorageCraftFilterView;
