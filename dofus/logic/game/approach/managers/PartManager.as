            ...
            case PartStateEnum.PART_UP_TO_DATE:
               if(param1.id == this._downloadingPart)
               {
                  ...
                  for each(_loc3_ in this._parts)
                  {
                     ...
                     {
                        _loc2_ = true;
                        _log.error(_loc3_.id + " en cours de téléchargement alors qu\'une autre part vient juste de se terminer...");
                        throw new Error(_loc3_.id + " en cours de téléchargement alors qu\'une autre part vient juste de se terminer...");
                     }
                  }
                  if(!_loc2_)
                  {
