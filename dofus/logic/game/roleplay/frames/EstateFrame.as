      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is HouseToSellFilterAction:
               ...
               (_loc5_ = new HouseToSellFilterMessage()).initHouseToSellFilterMessage(_loc4_.areaId,_loc4_.atLeastNbRoom,_loc4_.atLeastNbChest,_loc4_.skillRequested,_loc4_.maxPrice);
            ...
            case param1 is PaddockToSellFilterAction:
               ...
               (_loc7_ = new PaddockToSellFilterMessage()).initPaddockToSellFilterMessage(_loc6_.areaId,_loc6_.atLeastNbMount,_loc6_.atLeastNbMachine,_loc6_.maxPrice);
            ...
            case param1 is HouseToSellListRequestAction:
               ...
               (_loc9_ = new HouseToSellListRequestMessage()).initHouseToSellListRequestMessage(_loc8_.pageIndex);
            ...
            case param1 is PaddockToSellListRequestAction:
               ...
               (_loc11_ = new PaddockToSellListRequestMessage()).initPaddockToSellListRequestMessage(_loc10_.pageIndex);
