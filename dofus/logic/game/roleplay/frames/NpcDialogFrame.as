      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is NpcDialogReplyAction:
               ...
               (_loc4_ = new NpcDialogReplyMessage()).initNpcDialogReplyMessage(_loc3_.replyId);
            ...
            case param1 is LeaveDialogMessage:
               if((_loc5_ = param1 as LeaveDialogMessage).dialogType == DialogTypeEnum.DIALOG_DIALOG || _loc5_.dialogType == DialogTypeEnum.DIALOG_MARRIAGE)
               {
               ...
               {
                  if(_loc6_ = Kernel.getWorker().getFrame(TeleportBuddiesDialogFrame) as TeleportBuddiesDialogFrame)
                  {
