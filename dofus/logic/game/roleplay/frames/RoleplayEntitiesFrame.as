package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayEntitiesFrame extends AbstractEntitiesFrame implements Frame
   {
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is MapLoadedMessage:
               if(this._waitForMap)
               {
                  (_loc60_ = new MapInformationsRequestMessage()).initMapInformationsRequestMessage(MapDisplayManager.getInstance().currentMapPoint.mapId);
            ...
            case param1 is MapComplementaryInformationsDataMessage:
               ...
               this.redCells = _loc3_.redcells;
               this.blueCells = _loc3_.bluecells;
               if(!_loc4_)
               {
                  this.initNewMap();
                  ...
                  {
                     if(_loc71_ = this.addOrUpdateActor(_loc66_) as AnimatedCharacter)
                     {
                        ...
                        if(_loc72_ = _loc66_ as GameRolePlayCharacterInformations)
                        {
                           _loc64_ = 0;
                           _loc65_ = 0;
                           ...
                           if(_loc64_ > 0)
                           {
                              if((_loc75_ = Emoticon.getEmoticonById(_loc64_)) && _loc75_.persistancy)
                              {
                                 this._currentEmoticon = _loc75_.id;
                                 if(!_loc75_.aura)
                                 {
                                    _loc76_ = false;
                                    if((_loc77_ = new Date()).getTime() - _loc65_ >= _loc75_.duration)
                                    {
                                       _loc76_ = true;
                                    }
               ...
               for each(_loc80_ in _loc3_.houses)
               {
                  ...
                  (_loc84_ = new HousePropertiesMessage()).initHousePropertiesMessage(_loc80_);
               ...
               (_loc5_ = new InteractiveMapUpdateMessage()).initInteractiveMapUpdateMessage(_loc3_.interactiveElements);
               Kernel.getWorker().process(_loc5_);
               (_loc6_ = new StatedMapUpdateMessage()).initStatedMapUpdateMessage(_loc3_.statedElements);
            ...
            case param1 is GameRolePlayShowActorMessage:
               if((_loc8_ = param1 as GameRolePlayShowActorMessage).informations.contextualId == PlayedCharacterManager.getInstance().id)
               {
                  ...
                  if(_loc87_ = getEntityInfos(PlayedCharacterManager.getInstance().id) as GameRolePlayHumanoidInformations)
                  {
            ...
            case param1 is GameMapChangeOrientationsMessage:
               _loc12_ = (_loc11_ = param1 as GameMapChangeOrientationsMessage).orientations.length;
               _loc89_ = 0;
            ...
            case param1 is GameRolePlaySetAnimationMessage:
               ...
               if(!(_loc14_ = DofusEntities.getEntity(_loc13_.informations.contextualId) as AnimatedCharacter))
               {
            ...
            case param1 is EntityMovementCompleteMessage:
               _loc16_ = (_loc15_ = param1 as EntityMovementCompleteMessage).entity as AnimatedCharacter;
            ...
            case param1 is CharacterMovementStoppedMessage:
               ...
               if(OptionManager.getOptionManager("tiphon").auraMode > OptionEnum.AURA_NONE && OptionManager.getOptionManager("tiphon").alwaysShowAuraOnFront && _loc19_.getDirection() == DirectionsEnum.DOWN && _loc19_.getAnimation().indexOf(AnimationEnum.ANIM_STATIQUE) != -1 && PlayedCharacterManager.getInstance().state == PlayerLifeStatusEnum.STATUS_ALIVE_AND_KICKING)
               {
                  ...
                  {
                     if((_loc94_ = Emoticon.getEmoticonById(_loc93_)) && _loc94_.aura)
                     {
                  ...
                  if(_loc91_)
                  {
                     (_loc95_ = new EmotePlayRequestMessage()).initEmotePlayRequestMessage(_loc91_.id);
            ...
            case param1 is GameContextRemoveElementMessage:
               ...
               if((_loc27_ = this._monstersIds.indexOf(_loc25_.id)) != -1)
               {
            ...
            case param1 is UpdateMapPlayersAgressableStatusMessage:
               _loc31_ = (_loc29_ = param1 as UpdateMapPlayersAgressableStatusMessage).playerIds.length;
               _loc30_ = 0;
               while(_loc30_ < _loc31_)
               {
                  if(_loc32_ = getEntityInfos(_loc29_.playerIds[_loc30_]) as GameRolePlayHumanoidInformations)
                  {
            ...
            case param1 is UpdateSelfAgressableStatusMessage:
               ...
               if(_loc35_ = getEntityInfos(PlayedCharacterManager.getInstance().id) as GameRolePlayHumanoidInformations)
               {
            ...
            case param1 is PaddockRemoveItemRequestAction:
               ...
               (_loc43_ = new PaddockRemoveItemRequestMessage()).initPaddockRemoveItemRequestMessage(_loc42_.cellId);
            ...
            case param1 is MapNpcsQuestStatusUpdateMessage:
               ...
               if(MapDisplayManager.getInstance().currentMapPoint.mapId == _loc52_.mapId)
               {
                  ...
                  {
                     if(_loc101_ = this._npcList[_loc52_.npcsIdsWithQuest[_loc103_]])
                     {
                        if((_loc105_ = Quest.getFirstValidQuest(_loc52_.questFlags[_loc103_])) != null)
                        {
            ...
            case param1 is ShowCellMessage:
               ...
               _loc55_ = (_loc54_ = Kernel.getWorker().getFrame(RoleplayContextFrame) as RoleplayContextFrame).getActorName(_loc53_.sourceId);
            ...
            case param1 is StartZoomAction:
               ...
               if((_loc58_ = DofusEntities.getEntity(_loc57_.playerId) as DisplayObject) && _loc58_.stage)
               {
            ...
            case param1 is MapZoomMessage:
               ...
               {
                  if((_loc109_ = _loc108_ as FightTeam) && _loc109_.fight && _loc109_.teamInfos)
                  {
      ...
      private function playAnimationOnEntity(param1:AnimatedCharacter, param2:String, param3:Boolean, param4:uint, param5:Boolean) : void
      {
         ...
         else
         {
            ...
            else if(!_creaturesMode)
            {
               ...
               if(_loc7_ = param1.getSubEntitySlot(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_MOUNT_DRIVER,0) as TiphonSprite)
               {
      ...
      public function updateMonstersGroups() : void
      {
         ...
         var _loc2_:Dictionary = getEntitiesDictionnary();
         for each(_loc1_ in _loc2_)
         {
            if(_loc1_ is GameRolePlayGroupMonsterInformations)
            {
               this.updateMonstersGroup(_loc1_ as GameRolePlayGroupMonsterInformations);
            }
         }
      }
      ...
      private function updateMonstersGroup(param1:GameRolePlayGroupMonsterInformations) : void
      {
         ...
         var _loc8_:Vector.<MonsterInGroupLightInformations> = this.getMonsterGroup(param1.staticInfos);
         var _loc9_:Boolean = Monster.getMonsterById(param1.staticInfos.mainCreatureLightInfos.creatureGenericId).isMiniBoss;
         if(_loc8_)
         {
            for each(_loc2_ in _loc8_)
            {
               if(_loc2_.creatureGenericId == param1.staticInfos.mainCreatureLightInfos.creatureGenericId)
               {
         ...
         if(Dofus.getInstance().options.showEveryMonsters)
         {
            ...
            {
               _loc7_ = param1.staticInfos.underlings.length;
            }
            _loc10_ = new Vector.<EntityLook>(_loc7_,true);
            _loc11_ = new Vector.<Number>(_loc10_.length,true);
         }
         for each(_loc4_ in param1.staticInfos.underlings)
         {
            if(_loc10_)
            {
               ...
               else
               {
                  for each(_loc2_ in _loc8_)
                  {
                     if(_loc2_.creatureGenericId == _loc4_.creatureGenericId)
                     {
                        _loc8_.splice(_loc8_.indexOf(_loc2_),1);
                        _loc6_ = _loc2_.grade;
                        break;
               ...
               if(_loc6_ >= 0)
               {
                  _loc11_[_loc3_] = _loc5_.speedAdjust;
                  _loc10_[_loc3_] = EntityLookAdapter.toNetwork(TiphonEntityLook.fromString(_loc5_.look));
                  _loc3_++;
               }
            }
            if(!_loc9_ && Monster.getMonsterById(_loc4_.creatureGenericId).isMiniBoss)
            {
               _loc9_ = true;
               if(!_loc10_)
               {
         ...
         if(_loc10_)
         {
            this.manageFollowers(DofusEntities.getEntity(param1.contextualId) as AnimatedCharacter,_loc10_,_loc11_,null,true);
         }
      }
      ...
      private function getMonsterGroup(param1:GroupMonsterStaticInformations) : Vector.<MonsterInGroupLightInformations>
      {
         ...
         var _loc3_:PartyManagementFrame = null;
         var _loc4_:Vector.<PartyMemberWrapper> = null;
         var _loc5_:int = 0;
         var _loc6_:AlternativeMonstersInGroupLightInformations = null;
         var _loc7_:PartyMemberWrapper = null;
         var _loc8_:GroupMonsterStaticInformationsWithAlternatives;
         if(_loc8_ = param1 as GroupMonsterStaticInformationsWithAlternatives)
         {
            _loc3_ = Kernel.getWorker().getFrame(PartyManagementFrame) as PartyManagementFrame;
            if((_loc5_ = (_loc4_ = _loc3_.partyMembers).length) == 0 && PlayedCharacterManager.getInstance().hasCompanion)
            {
               _loc5_ = 2;
            }
            else
            {
               ...
               {
                  _loc5_ = _loc5_ + _loc7_.companions.length;
               }
            }
            for each(_loc6_ in _loc8_.alternatives)
            {
               if(!_loc2_ || _loc6_.playerCount <= _loc5_)
               {
                  _loc2_ = _loc6_.monsters;
               }
            }
         }
      ...
      override public function addOrUpdateActor(param1:GameContextActorInformations, param2:IAnimationModifier = null) : AnimatedCharacter
      {
         ...
         switch(true)
         {
            ...
            case param1 is GameRolePlayGroupMonsterInformations:
               ...
               if(!(_loc7_ = Monster.getMonsterById(_loc6_.staticInfos.mainCreatureLightInfos.creatureGenericId).isMiniBoss) && _loc6_.staticInfos.underlings && _loc6_.staticInfos.underlings.length > 0)
               {
      ...
      override protected function updateActorLook(param1:int, param2:EntityLook, param3:Boolean = false) : AnimatedCharacter
      {
         ...
         var _loc10_:Follower = null;
         var _loc11_:AnimatedCharacter;
         if(_loc11_ = DofusEntities.getEntity(param1) as AnimatedCharacter)
         {
            _loc4_ = (TiphonUtility.getEntityWithoutMount(_loc11_) as TiphonSprite).getAnimation();
            if(!_creaturesMode)
            {
               _loc6_ = EntityLookAdapter.fromNetwork(param2).getSubEntitiesFromCategory(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_PET_FOLLOWER);
               _loc7_ = [];
               _loc8_ = false;
               for each(_loc9_ in _loc6_)
               {
                  _loc8_ = false;
                  for each(_loc10_ in _loc11_.followers)
                  {
                     if(_loc10_.type == Follower.TYPE_PET && _loc10_.entity is TiphonSprite && (_loc10_.entity as TiphonSprite).look.equals(_loc9_))
                     {
                        _loc8_ = true;
                        break;
                     }
               ...
               {
                  _loc11_.addFollower(this.createFollower(_loc9_,_loc11_,Follower.TYPE_PET),true);
               }
            }
            _loc5_ = [];
            for each(_loc10_ in _loc11_.followers)
            {
               _loc8_ = false;
               if(_loc10_.type == Follower.TYPE_PET)
               {
                  for each(_loc9_ in _loc6_)
                  {
                     if(_loc10_.entity is TiphonSprite && (_loc10_.entity as TiphonSprite).look.equals(_loc9_))
                     {
                        _loc8_ = true;
                        break;
                     }
            ...
            {
               _loc11_.removeFollower(_loc10_);
            }
            if(_loc4_.indexOf("_Statique_") != -1 && (!this._lastStaticAnimations[param1] || this._lastStaticAnimations[param1] != _loc4_))
            {
               this._lastStaticAnimations[param1] = {"anim":_loc4_};
            }
            if(_loc11_.look.getBone() != param2.bonesId && this._lastStaticAnimations[param1])
            {
               this._lastStaticAnimations[param1].targetBone = param2.bonesId;
               _loc11_.removeEventListener(TiphonEvent.RENDER_SUCCEED,this.onEntityRendered);
               _loc11_.addEventListener(TiphonEvent.RENDER_SUCCEED,this.onEntityRendered);
      ...
      {
         var _loc2_:FightTeamInformations = null;
         var _loc3_:IEntity = null;
         var _loc4_:FightTeam = null;
         var _loc7_:uint = 0;
         var _loc5_:Vector.<FightTeam> = new Vector.<FightTeam>(0,false);
         var _loc6_:Fight = new Fight(param1.fightId,_loc5_);
         for each(_loc2_ in param1.fightTeams)
         {
            _loc3_ = RolePlayEntitiesFactory.createFightEntity(param1,_loc2_,MapPoint.fromCellId(param1.fightTeamsPositions[_loc7_]));
            (_loc3_ as IDisplayable).display();
            _loc4_ = new FightTeam(_loc6_,_loc2_.teamTypeId,_loc3_,_loc2_,param1.fightTeamsOptions[_loc2_.teamId]);
            _entities[_loc3_.id] = _loc4_;
            _loc5_.push(_loc4_);
            _loc7_++;
            (_loc3_ as TiphonSprite).addEventListener(TiphonEvent.RENDER_SUCCEED,this.onFightEntityRendered,false,0,true);
         }
         this._fights[param1.fightId] = _loc6_;
      }
      ...
      private function addObject(param1:uint, param2:uint) : void
      {
         ...
         var _loc4_:IInteractive;
         ((_loc4_ = new RoleplayObjectEntity(param1,MapPoint.fromCellId(param2))) as IDisplayable).display();
         var _loc5_:GameContextActorInformations;
         (_loc5_ = new GroundObject(Item.getItemById(param1))).contextualId = _loc4_.id;
      ...
      private function updateFight(param1:uint, param2:FightTeamInformations) : void
      {
         ...
         var _loc6_:Fight;
         if((_loc6_ = this._fights[param1]) == null)
         {
            return;
         }
         var _loc7_:FightTeam = _loc6_.getTeamById(param2.teamId);
         var _loc8_:FightTeamInformations;
         if((_loc8_ = (_entities[_loc7_.teamEntity.id] as FightTeam).teamInfos).teamMembers == param2.teamMembers)
         {
            return;
         }
         for each(_loc3_ in param2.teamMembers)
         {
            _loc4_ = false;
            for each(_loc5_ in _loc8_.teamMembers)
            {
            ...
            if(!_loc4_)
            {
               _loc8_.teamMembers.push(_loc3_);
            }
         }
      }
      ...
      private function removeFighter(param1:uint, param2:uint, param3:int) : void
      {
         ...
         var _loc6_:Vector.<FightTeamMemberInformations> = null;
         var _loc7_:FightTeamMemberInformations = null;
         var _loc8_:Fight;
         if(_loc8_ = this._fights[param1])
         {
            _loc5_ = (_loc4_ = _loc8_.teams[param2]).teamInfos;
            _loc6_ = new Vector.<FightTeamMemberInformations>(0,false);
            for each(_loc7_ in _loc5_.teamMembers)
            {
               if(_loc7_.id != param3)
               {
                  _loc6_.push(_loc7_);
      ...
      private function removeFight(param1:uint) : void
      {
         ...
         var _loc4_:Fight;
         if((_loc4_ = this._fights[param1]) == null)
         {
            return;
         }
         for each(_loc2_ in _loc4_.teams)
         {
            _loc3_ = _entities[_loc2_.teamEntity.id];
            Kernel.getWorker().process(new EntityMouseOutMessage(_loc2_.teamEntity as IInteractive));
            (_loc2_.teamEntity as IDisplayable).remove();
            TooltipManager.hide("fightOptions_" + param1 + "_" + _loc2_.teamInfos.teamId);
            delete _entities[_loc2_.teamEntity.id];
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:Item = Item.getItemById(param1.objectGID);
         if(this._paddockItem[param1.cellId])
         {
            _loc2_ = (this._paddockItem[param1.cellId] as IEntity).id;
         }
         else
         {
            _loc2_ = EntitiesManager.getInstance().getFreeEntityId();
         }
         var _loc4_:GameContextPaddockItemInformations = new GameContextPaddockItemInformations(_loc2_,_loc3_.appearance,param1.cellId,param1.durability,_loc3_);
      ...
      private function activatePaddockItem(param1:uint) : void
      {
         ...
         var _loc3_:TiphonSprite = this._paddockItem[param1];
         if(_loc3_)
         {
            _loc2_ = new SerialSequencer();
            _loc2_.addStep(new PlayAnimationStep(_loc3_,AnimationEnum.ANIM_HIT));
            _loc2_.addStep(new PlayAnimationStep(_loc3_,AnimationEnum.ANIM_STATIQUE));
            _loc2_.start();
         }
      }
      ...
      private function updateSwordOptions(param1:uint, param2:uint, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         var _loc7_:FightTeam;
         if((_loc7_ = _loc6_.teams[param2]) == null)
         {
            return;
         }
         if(param3 != -1)
         {
            _loc7_.teamOptions[param3] = param4;
         }
         var _loc8_:Vector.<String> = new Vector.<String>();
         for(_loc5_ in _loc7_.teamOptions)
         {
            if(_loc7_.teamOptions[_loc5_])
            {
               _loc8_.push("fightOption" + _loc5_);
            }
         }
         if(_loc7_.hasGroupMember())
         {
            _loc8_.push("fightOption4");
         }
         TooltipManager.show(_loc8_,(_loc7_.teamEntity as IDisplayable).absoluteBounds,UiModuleManager.getInstance().getModule("Ankama_Tooltips"),false,"fightOptions_" + param1 + "_" + param2,LocationEnum.POINT_BOTTOM,LocationEnum.POINT_TOP,0,true,"texturesList",null,null,null,false,0,Atouin.getInstance().currentZoom,false);
      }
      
      private function paddockCellValidator(param1:int) : Boolean
      {
         var _loc2_:GameContextActorInformations = null;
         var _loc3_:IEntity = EntitiesManager.getInstance().getEntityOnCell(param1);
         if(_loc3_)
         {
            _loc2_ = getEntityInfos(_loc3_.id);
            if(_loc2_ is GameContextPaddockItemInformations)
            {
               return false;
            }
         }
      ...
      private function removeEntityListeners(param1:int) : void
      {
         ...
         var _loc3_:TiphonSprite = DofusEntities.getEntity(param1) as TiphonSprite;
         if(_loc3_)
         {
            _loc3_.removeEventListener(TiphonEvent.ANIMATION_END,this.onAnimationEnd);
            _loc2_ = _loc3_.getSubEntitySlot(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_MOUNT_DRIVER,0) as TiphonSprite;
            if(_loc2_)
            {
               _loc2_.removeEventListener(TiphonEvent.ANIMATION_ADDED,this.onAnimationAdded);
            }
            _loc3_.removeEventListener(TiphonEvent.RENDER_SUCCEED,this.onEntityReadyForEmote);
         }
      }
      ...
      private function updateUsableEmotesListInit(param1:TiphonEntityLook) : void
      {
         ...
         {
            _loc3_ = _entities[PlayedCharacterManager.getInstance().id] as GameContextActorInformations;
            _loc2_ = EntityLookAdapter.fromNetwork(_loc3_.look);
         }
         var _loc5_:Array = _loc2_.getSubEntitiesFromCategory(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_PET_FOLLOWER);
         if((_creaturesMode || _creaturesFightMode || _loc5_ && _loc5_.length != 0) && _loc2_)
         {
            _loc4_ = TiphonMultiBonesManager.getInstance().getAllBonesFromLook(_loc2_);
            TiphonMultiBonesManager.getInstance().forceBonesLoading(_loc4_,new Callback(this.updateUsableEmotesList,_loc2_));
         }
         else
         {
      ...
      private function updateUsableEmotesList(param1:TiphonEntityLook) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:ShortcutWrapper = null;
         var _loc8_:int = 0;
         var _loc13_:Boolean = false;
         var _loc9_:Boolean = PlayedCharacterManager.getInstance().isGhost;
         var _loc10_:EmoticonFrame;
         var _loc11_:Array = (_loc10_ = Kernel.getWorker().getFrame(EmoticonFrame) as EmoticonFrame).emotesList;
         var _loc12_:Array = param1.getSubEntities();
         this._usableEmotes = new Array();
         var _loc14_:uint = param1.getBone();
         for each(_loc2_ in _loc11_)
         {
            _loc4_ = false;
            if(_loc2_ && _loc2_.emote)
            {
               _loc3_ = _loc2_.emote.getAnimName(param1);
               if(_loc2_.emote.aura && !_loc9_ || Tiphon.skullLibrary.hasAnim(param1.getBone(),_loc3_))
               {
                  _loc4_ = true;
               }
               else if(_loc12_)
               {
                  ...
                  {
                     for(_loc6_ in _loc12_[_loc5_])
                     {
                        if(Tiphon.skullLibrary.hasAnim(_loc12_[_loc5_][_loc6_].getBone(),_loc3_))
                        {
                           _loc4_ = true;
                           break;
                        }
               ...
               _loc8_ = _loc10_.emotes.indexOf(_loc2_.id);
               for each(_loc7_ in InventoryManager.getInstance().shortcutBarItems)
               {
                  if(_loc7_ && _loc7_.type == 4 && _loc7_.id == _loc2_.id && _loc7_.active != _loc4_)
                  {
                     _loc7_.active = _loc4_;
                     _loc13_ = true;
                     break;
                  }
               }
               if(_loc4_)
               {
                  this._usableEmotes.push(_loc2_.id);
                  if(_loc8_ == -1)
                  {
                     _loc10_.emotes.push(_loc2_.id);
                  }
               }
               else if(_loc8_ != -1)
               {
                  _loc10_.emotes.splice(_loc8_,1);
               }
            }
         }
      ...
      private function onAnimationAdded(param1:TiphonEvent) : void
      {
         ...
         (_loc6_ = param1.currentTarget as TiphonSprite).removeEventListener(TiphonEvent.ANIMATION_ADDED,this.onAnimationAdded);
         var _loc7_:TiphonAnimation = _loc6_.rawAnimation;
         var _loc8_:SoundBones;
         if(_loc8_ = SoundBones.getSoundBonesById(_loc6_.look.getBone()))
         {
            _loc2_ = getQualifiedClassName(_loc7_);
            _loc3_ = _loc8_.getSoundAnimations(_loc2_);
            _loc7_.spriteHandler.tiphonEventManager.removeEvents(TiphonEventsManager.BALISE_SOUND,_loc2_);
            for each(_loc4_ in _loc3_)
            {
               ...
               _loc7_.spriteHandler.tiphonEventManager.addEvent(_loc5_,_loc4_.startFrame,_loc2_);
            }
         }
      }
      ...
      private function onAnimationEnd(param1:TiphonEvent) : void
      {
         var _loc2_:String = null;
         var _loc3_:String = null;
         var _loc4_:TiphonSprite;
         (_loc4_ = param1.currentTarget as TiphonSprite).removeEventListener(TiphonEvent.ANIMATION_END,this.onAnimationEnd);
         var _loc5_:Object;
         if((_loc5_ = _loc4_.getSubEntitySlot(SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_MOUNT_DRIVER,0)) != null)
         {
            _loc3_ = _loc5_.getAnimation();
            if(_loc3_.indexOf("_") == -1)
            {
               _loc3_ = _loc4_.getAnimation();
            }
         }
         else
         {
         ...
         if(_loc3_.indexOf("_Statique_") == -1)
         {
            _loc2_ = _loc3_.replace("_","_Statique_");
         }
         else
         {
            _loc2_ = _loc3_;
         }
         if(_loc4_.hasAnimation(_loc2_,_loc4_.getDirection()) || _loc5_ && _loc5_ is TiphonSprite && TiphonSprite(_loc5_).hasAnimation(_loc2_,TiphonSprite(_loc5_).getDirection()))
         {
            _loc4_.setAnimation(_loc2_);
         }
         else
         {
      ...
      private function onCellPointed(param1:Boolean, param2:uint, param3:int) : void
      {
         ...
         if(param1)
         {
            (_loc4_ = new PaddockMoveItemRequestMessage()).initPaddockMoveItemRequestMessage(this._currentPaddockItemCellId,param2);
      ...
      private function addConquestIcon(param1:int, param2:HumanOptionAlliance) : void
      {
         ...
         if(PlayedCharacterManager.getInstance().characteristics.alignmentInfos.aggressable != AggressableStatusEnum.NON_AGGRESSABLE && this._allianceFrame && this._allianceFrame.hasAlliance && param2.aggressable != AggressableStatusEnum.NON_AGGRESSABLE && param2.aggressable != AggressableStatusEnum.PvP_ENABLED_AGGRESSABLE && param2.aggressable != AggressableStatusEnum.PvP_ENABLED_NON_AGGRESSABLE)
         {
            ...
            if(_loc3_ && _loc3_.state == PrismStateEnum.PRISM_STATE_VULNERABLE)
            {
               ...
               if(_loc4_)
               {
                  if((_loc5_ = this.getIconNamesByCategory(param1,EntityIconEnum.AVA_CATEGORY)) && _loc5_[0] != _loc4_)
                  {
                     _loc6_ = _loc5_[0];
                     _loc5_.length = 0;
            ...
            else
            {
               ...
               if(this._updateAllIcons || _loc4_.isMoving || !this._entitiesIcons[_loc2_] || this._entitiesIcons[_loc2_].needUpdate)
               {
                  ...
                  if(_loc3_)
                  {
                     ...
                     if((_loc5_ = _loc7_ = new Rectangle2(_loc6_.x,_loc6_.y,_loc6_.width,_loc6_.height)).y - 30 - 10 < 0)
                     {
                        if(_loc11_ = _loc10_.getSlot("Pied"))
                        {
               ...
               if(_loc5_)
               {
                  if(!(_loc8_ = this._entitiesIcons[_loc2_]))
                  {
      ...
      private function onAuraCycleTimer(param1:TimerEvent) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc6_:Vector.<int> = getEntitiesIdsList();
         if(this._auraCycleIndex >= _loc6_.length)
         {
            this._auraCycleIndex = 0;
         }
         ...
         while(_loc8_ < _loc7_)
         {
            if(_loc5_ = DofusEntities.getEntity(_loc6_[_loc8_]) as AnimatedCharacter)
            {
               if(!_loc3_ && _loc5_.hasAura && _loc5_.getDirection() == DirectionsEnum.DOWN)
               {
                  _loc3_ = _loc5_;
                  _loc2_ = _loc8_;
               }
               if(_loc8_ == this._auraCycleIndex && _loc5_.hasAura && _loc5_.getDirection() == DirectionsEnum.DOWN)
               {
                  _loc4_ = _loc5_;
                  break;
               }
         ...
         {
            _loc3_.visibleAura = true;
            this._lastEntityWithAura = _loc3_;
            this._auraCycleIndex = _loc2_;
         }
         ++this._auraCycleIndex;
      }
      ...
      private function setEntitiesAura(param1:Boolean) : void
      {
         var _loc2_:AnimatedCharacter = null;
         var _loc4_:int = 0;
         var _loc3_:Vector.<int> = getEntitiesIdsList();
         while(_loc4_ < _loc3_.length)
         {
            _loc2_ = DofusEntities.getEntity(_loc3_[_loc4_]) as AnimatedCharacter;
            if(_loc2_)
            {
               _loc2_.visibleAura = param1;
            }
            _loc4_++;
         }
      }
