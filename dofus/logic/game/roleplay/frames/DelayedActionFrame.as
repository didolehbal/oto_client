   ...
   public class DelayedActionFrame implements Frame
   {
      ...
      public function showItemUse(param1:int, param2:uint, param3:Number) : void
      {
         ...
         if(DofusEntities.getEntity(param1))
         {
            ...
            (_loc7_ = TooltipManager.show(_loc5_,_loc6_,UiModuleManager.getInstance().getModule("Ankama_Tooltips"),false,TOOLTIP_NAME + param1,LocationEnum.POINT_BOTTOM,LocationEnum.POINT_TOP,0,true,null,null,{"endTime":_loc4_},null,false,-1)).mustBeHidden = false;
