package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayWorldFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc112_:Boolean = false;
         var _loc113_:InteractiveElementWithAgeBonus = null;
         var _loc114_:SubArea = null;
         switch(true)
         {
            ...
            case param1 is AdjacentMapClickMessage:
               ...
               if(this.cellClickEnabled)
               {
                  ...
                  if(!(_loc52_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id)))
                  {
            ...
            case param1 is AdjacentMapOverMessage:
               ...
               _loc5_ = (_loc4_ = InteractiveCellManager.getInstance().getCell(_loc2_.cellId)).parent.localToGlobal(new Point(_loc4_.x,_loc4_.y));
               ...
               if(_loc9_)
               {
                  if((_loc114_ = PlayedCharacterManager.getInstance().currentSubArea) != null)
                  {
                     if(_loc9_.id != _loc114_.id)
                     {
                        _loc10_ = true;
                  ...
                  if((_loc53_ = MapPosition.getMapPositionById(_loc8_)).showNameOnFingerpost && _loc53_.name)
                  {
               ...
               if(_loc10_)
               {
                  ...
                  (_loc56_ = new Object()).classCss = "center";
            ...
            case param1 is MapComplementaryInformationsDataMessage:
               ...
               if(Atouin.getInstance().options.frustum.containsPoint(_loc15_))
               {
                  ...
                  _loc61_ = (_loc60_ = Berilia.getInstance().getUi("banner")).getElement("mainCtr");
                  _loc62_ = _loc60_.getElements();
                  var _loc115_:int = 0;
                  var _loc116_:* = _loc57_;
                  do
                  {
                     for each(_loc58_ in _loc116_)
                     {
                        ...
                        {
                           if((_loc63_ = _loc62_[_loc64_]) == _loc59_ && _loc64_.indexOf("elem_") == -1)
                           {
                              _loc65_ = true;
                              break;
                           }
                  ...
                  while(!(_loc59_ && _loc65_ && _loc61_.contains(_loc59_)));
            ...
            case param1 is EntityMouseOverMessage:
               ...
               if(_loc19_ = (_loc18_ = _loc16_.entity as IInteractive) as AnimatedCharacter)
               {
                  (_loc19_ = _loc19_.getRootEntity()).highLightCharacterAndFollower(true);
                  _loc18_ = _loc19_;
               ...
               if(_loc18_ is TiphonSprite)
               {
                  ...
                  if(_loc69_ = _loc66_.getSlot("Tete"))
                  {
                     _loc70_ = _loc69_.getBounds(StageShareManager.stage);
                     _loc21_ = _loc71_ = new Rectangle2(_loc70_.x,_loc70_.y,_loc70_.width,_loc70_.height);
                  }
               }
               ...
               else
               {
                  switch(true)
                  {
                     ...
                     case _loc20_ is GameRolePlayTaxCollectorInformations:
                        ...
                        _loc76_ = (_loc75_ = _loc20_ as GameRolePlayTaxCollectorInformations).identification.guildIdentity;
                     ...
                     case _loc20_ is GameRolePlayNpcInformations:
                        ...
                        if((_loc80_ = Npc.getNpcById(_loc79_.npcId)) == null)
                        {
                           return false;
                        }
                        (_loc20_ = new TextTooltipInfo(_loc80_.name,XmlConfig.getInstance().getEntry("config.ui.skin") + "css/tooltip_npc.css","green",0)).bgCornerRadius = 10;
                     ...
                     case _loc20_ is GameRolePlayTreasureHintInformations:
                        ...
                        (_loc20_ = new TextTooltipInfo(_loc83_.name,XmlConfig.getInstance().getEntry("config.ui.skin") + "css/tooltip_npc.css","orange",0)).bgCornerRadius = 10;
            ...
            case param1 is MouseRightClickMessage:
               ...
               if(_loc27_ = _loc25_.target as IInteractive)
               {
                  ...
                  if(_loc87_ is GameRolePlayNamedActorInformations)
                  {
                     ...
                     if(_loc88_ = MenusFactory.create(_loc89_,"multiplayer",[_loc27_]))
                     {
                  ...
                  {
                     if(_loc88_ = MenusFactory.create(_loc87_,"monsterGroup",[_loc27_]))
                     {
                        _loc26_.createContextMenu(_loc88_);
                     }
                     return true;
            ...
            case param1 is EntityMouseOutMessage:
               ...
               if(_loc19_ = _loc28_.entity as AnimatedCharacter)
               {
                  (_loc19_ = _loc19_.getRootEntity()).highLightCharacterAndFollower(false);
            ...
            case param1 is EntityClickMessage:
               if((_loc30_ = (_loc29_ = param1 as EntityClickMessage).entity as IInteractive) is AnimatedCharacter)
               {
               ...
               if(this.roleplayContextFrame.entitiesFrame.isFight(_loc30_.id))
               {
                  ...
                  if((_loc92_ = this.roleplayContextFrame.entitiesFrame.getFightTeamType(_loc30_.id)) == TeamTypeEnum.TEAM_TYPE_TAXCOLLECTOR)
                  {
                     ...
                     if((_loc98_ = (Kernel.getWorker().getFrame(SocialFrame) as SocialFrame).guild) && _loc95_ == _loc98_.guildId)
                     {
                  ...
                  (_loc93_ = new GameFightJoinRequestMessage()).initGameFightJoinRequestMessage(_loc91_,_loc90_);
                  if(((_loc94_ = DofusEntities.getEntity(PlayedCharacterManager.getInstance().id)) as IMovable).isMoving)
                  {
            ...
            case param1 is InteractiveElementActivationMessage:
               ...
               if(!((_loc34_ = Kernel.getWorker().getFrame(RoleplayInteractivesFrame) as RoleplayInteractivesFrame) && _loc34_.usingInteractive))
               {
                  ...
                  while(_loc101_ < 8)
                  {
                     if(_loc102_ = _loc33_.position.getNearestCellInDirection(_loc101_))
                     {
                        if(!(_loc104_ = _loc103_[_loc102_.cellId]).mov || _loc104_.farmCell)
                        {
                           if(!_loc100_)
                           {
                              _loc100_ = [];
                  ...
                  if(!(_loc105_ = _loc33_.position.getNearestFreeCellInDirection(_loc33_.position.advancedOrientationTo(_loc99_.position),DataMapProvider.getInstance(),true,true,false,_loc100_)) || _loc100_.indexOf(_loc105_.cellId) != -1)
                  {
            ...
            case param1 is InteractiveElementMouseOverMessage:
               ...
               _loc39_ = (_loc35_ = param1 as InteractiveElementMouseOverMessage).interactiveElement;
               ...
               _loc44_ = (_loc43_ = Kernel.getWorker().getFrame(RoleplayEntitiesFrame) as RoleplayEntitiesFrame).housesInformations[_loc42_];
               ...
               {
                  (_loc106_ = new Object()).interactive = _loc41_.name;
                  _loc106_.isCollectable = false;
                  _loc107_ = "";
                  for each(_loc40_ in _loc39_.enabledSkills)
                  {
                     if((_loc108_ = Skill.getSkillById(_loc40_.skillId)).elementActionId == ACTION_COLLECTABLE_RESOURCES)
                     {
                  ...
                  if(_loc106_.isCollectable)
                  {
                     ...
                     {
                        if((_loc111_ = Skill.getSkillById(_loc39_.enabledSkills[0].skillId)).parentJobId == 1)
                        {
                           _loc112_ = false;
                        }
                     }
            ...
            case param1 is MouseUpMessage:
               ...
               if((_loc49_ = Kernel.getWorker().getFrame(ShortcutsFrame) as ShortcutsFrame).heldShortcuts.indexOf("showMonstersInfo") == -1 && Kernel.getWorker().contains(MonstersInfoFrame))
               {
                  Kernel.getWorker().removeFrame(_monstersInfoFrame);
               }
         }
