package com.ankamagames.dofus.logic.game.roleplay.managers
{
   ...
   public class RoleplayManager implements IDestroyable
   {
      ...
      public function getKamasReward(param1:Boolean = true, param2:int = -1, param3:Number = 1, param4:Number = 1, param5:int = -1) : Number
      {
         if(param5 == -1 && param1)
         {
            param5 = PlayedCharacterManager.getInstance().infos.level;
         }
      ...
      {
         var _loc6_:int = 0;
         var _loc7_:Number = 1 + param2 / 100;
         if(param1 > param3)
         {
            _loc6_ = Math.min(param1,param3 * REWARD_SCALE_CAP);
            return ((1 - REWARD_REDUCED_SCALE) * this.getFixeExperienceReward(param3,param5,param4) + REWARD_REDUCED_SCALE * this.getFixeExperienceReward(_loc6_,param5,param4)) * _loc7_;
         }
         return this.getFixeExperienceReward(param1,param5,param4) * _loc7_;
      }
