package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightMovementPointsVariationStep extends AbstractStatContextualStep implements IFightStep
   {
      ...
      override public function start() : void
      {
         ...
         {
            _loc2_.stats.movementPoints = _loc2_.stats.movementPoints + this._intValue;
            _loc1_ = CurrentPlayedFighterManager.getInstance().getCharacteristicsInformations(_targetId);
            if(_loc1_)
            {
               _loc1_.movementPointsCurrent = _loc2_.stats.movementPoints;
            }
