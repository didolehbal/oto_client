package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class TacticModeManager
   {
            ...
            if(!this._debugMode || this._debugMode && this._flattenCells)
            {
               ...
               while(_loc3_ < _loc4_)
               {
                  if(this._cellsRef[_loc3_] != null)
                  {
                     ...
                     {
                        (_loc10_ = InteractiveCellManager.getInstance().getCell(this._cellsRef[_loc3_].id)).y = this._cellsRef[_loc3_].elevation + this._cellsData[_loc3_].floor;
         ...
         else
         {
            ...
            while(_loc3_ < _loc4_)
            {
               ...
               if(!_loc7_.isDisabled)
               {
                  ...
                  {
                     (_loc10_ = InteractiveCellManager.getInstance().getCell(_loc7_.id)).y = _loc7_.elevation + _loc6_.floor;
                     this.updateEntitiesOnCell(_loc3_);
                  }
            ...
            _loc3_ = 0;
            for(; _loc3_ < _loc4_; _loc3_ = _loc3_ + 1)
            {
               switch(this._cellZones[_loc3_])
               {
                  ...
                  default:
                     ...
                     {
                        (_loc16_ = new Object()).map = new Vector.<int>();
      ...
      public function hide(param1:Boolean = false) : void
      {
         ...
         var _loc7_:int = this._cellsRef.length;
         _loc5_ = 0;
         while(_loc5_ < _loc7_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(_loc4_.floor != 0)
               {
                  (_loc6_ = InteractiveCellManager.getInstance().getCell(_loc3_.id)).y = _loc3_.elevation;
      ...
      private function updateEntitiesOnCell(param1:uint) : void
      {
         ...
         var _loc4_:Array = EntitiesManager.getInstance().getEntitiesOnCell(param1);
         for each(_loc3_ in _loc4_)
         {
            _loc2_ = DofusEntities.getEntity(_loc3_.id) as AnimatedCharacter;
            if(_loc2_)
            {
               _loc2_.jump(_loc2_.position);
            }
         }
      }
      ...
      private function clearUnneededCells(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc9_:int = Math.abs(param4) + Math.abs(param2);
         var _loc10_:int = CellIdConverter.coordToCellId(_loc8_ / 2 + param3,_loc9_ / 2 + param4);
         var _loc11_:ZRectangle;
         var _loc12_:Vector.<uint> = (_loc11_ = new ZRectangle(0,_loc8_ / 2,_loc9_ / 2,null)).getCells(_loc10_);
         if(this._debugMode && this._showFightZone)
         {
            ...
            this._fightZone.zone = _loc11_;
            this._debugCellId = _loc10_;
         }
         var _loc13_:Vector.<uint>;
         var _loc14_:int = (_loc13_ = this._unreachablePath.concat()).length;
         _loc6_ = 0;
         while(_loc6_ < _loc14_)
         {
            _loc5_ = _loc13_[_loc6_];
            if((_loc7_ = this.getInformations(_loc5_))[1] || _loc12_.indexOf(_loc5_) == -1 && !_loc7_[0])
            {
               this._unreachablePath.splice(this._unreachablePath.indexOf(_loc5_),1);
            }
            _loc6_ = _loc6_ + 1;
         }
         _loc13_ = null;
      ...
      private function updateCellWithRealCellZone() : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc12_:int = this._cellZones.length;
         ...
         while(_loc6_ < _loc12_)
         {
            ...
            if(_loc1_ > 0)
            {
               ...
               if(_loc5_.length > 0)
               {
                  ...
                  while(_loc7_ < _loc8_)
                  {
                     if(_loc1_ != _loc5_[_loc7_] && !this.containZone(_loc13_,_loc1_,_loc5_[_loc7_]))
                     {
                        _loc13_.push({
                           "z1":_loc1_,
                           "z2":_loc5_[_loc7_]
         ...
         if(_loc13_.length > 0)
         {
            ...
            {
               if(this._cellZones.indexOf(_loc13_[_loc7_].z1) != -1 && this._cellZones.indexOf(_loc13_[_loc7_].z2) != -1)
               {
                  _loc10_ = Math.min(_loc13_[_loc7_].z1,_loc13_[_loc7_].z2);
                  _loc11_ = Math.max(_loc13_[_loc7_].z1,_loc13_[_loc7_].z2);
                  _loc9_ = 0;
                  while(_loc9_ < _loc12_)
                  {
                     if(this._cellZones[_loc9_] == _loc11_)
                     {
                        this._cellZones[_loc9_] = _loc10_;
                     }
                     _loc9_ = _loc9_ + 1;
                  }
               }
