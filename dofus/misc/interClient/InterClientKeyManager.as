package com.ankamagames.dofus.misc.interClient
{
   ...
   public class InterClientKeyManager
   {
      ...
      private function pingNext() : void
      {
         ...
         else
         {
            ...
            if(this._clientsIds.length == 0)
            {
               ...
               if(!(_loc4_ = _loc3_.data["identity"]) || _loc4_.length > KEY_SIZE - 3)
               {
      ...
      private function saveKey(param1:String, param2:uint = 1) : void
      {
         ...
         this._key = param1;
         this._keyTimestamp = _loc4_.getTime();
         _loc3_ = param1 + "#" + (param2 < 10?"0" + param2:param2);
         InterClientManager.getInstance().flashKey = _loc3_;
      }
