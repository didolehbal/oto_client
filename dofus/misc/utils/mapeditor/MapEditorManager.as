package com.ankamagames.dofus.misc.utils.mapeditor
{
   ...
   public class MapEditorManager
   {
      ...
      private function displayPopup(param1:String, param2:uint, param3:Boolean = false) : void
      {
         ...
         (_loc4_ = new TextField()).defaultTextFormat = new TextFormat("Verdana",12,0,true);
         ...
         switch(param1.data.type)
         {
            ...
            case MapEditorMessage.MESSAGE_TYPE_NPC:
               ...
               while(_loc9_ < _loc5_)
               {
                  ...
                  (_loc14_ = new EntityDispositionInformations()).initEntityDispositionInformations(_loc11_,_loc13_);
