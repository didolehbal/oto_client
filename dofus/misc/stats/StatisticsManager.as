package com.ankamagames.dofus.misc.stats
{
   ...
   public class StatisticsManager
   {
      ...
      private function getActionDataId(param1:uint) : String
      {
         ...
         var _loc3_:String = !!PlayedCharacterManager.getInstance().infos?PlayedCharacterManager.getInstance().infos.name:null;
         var _loc4_:String = PlayerManager.getInstance().nickname;
         if(_loc3_)
         {
            _loc2_ = _loc3_;
         }
         ...
         return !!_loc2_?_loc2_ + "#" + _loc5_:_loc5_;
      }
