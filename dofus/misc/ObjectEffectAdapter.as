   ...
   public class ObjectEffectAdapter
   {
      ...
      public static function fromNetwork(param1:ObjectEffect) : EffectInstance
      {
         ...
         if(param1 is ObjectEffectDice && param1.actionId == 669)
         {
            ...
            do
            {
               if(_loc6_ = IncarnationLevel.getIncarnationLevelByIdAndLevel(ObjectEffectDice(param1).diceNum,_loc3_))
               {
                  _loc4_ = _loc6_.requiredXp;
               }
               if(_loc7_ = IncarnationLevel.getIncarnationLevelByIdAndLevel(ObjectEffectDice(param1).diceNum,++_loc3_))
               {
