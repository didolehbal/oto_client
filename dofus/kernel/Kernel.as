   ...
   public class Kernel
   {
      ...
      public function initOptions() : void
      {
         ...
         else if(Constants.LOG_UPLOAD_MODE)
         {
            ...
            _loc1_.content = "Vous participez au programme d\'analyse des performances de Dofus 2.0 mais le système de log est désactivé dans les options (Options -> Support)";
            _loc1_.show();
         }
      }
