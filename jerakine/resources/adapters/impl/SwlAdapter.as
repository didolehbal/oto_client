   ...
   public class SwlAdapter extends AbstractUrlLoaderAdapter implements IAdapter
   {
      ...
      private function onLibraryInit(param1:uint, param2:Array) : Function
      {
         ...
         return function(param1:Event):void
         {
            ...
            var _loc4_:*;
            var _loc5_:* = (_loc4_ = param1.target as LoaderInfo).applicationDomain;
            var _loc6_:*;
            if(_loc6_ = _loc4_.content as MovieClip)
            {
               _loc2_ = _loc6_.numChildren;
               _loc3_ = -1;
               while(++_loc3_ < _loc2_)
               {
            ...
            createResource(frameRate,classesList,_loc5_);
            releaseLoader();
         };
      }
