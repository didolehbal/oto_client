package com.ankamagames.jerakine.resources.loaders
{
   ...
   public class AbstractRessourceLoader extends EventDispatcher implements IResourceObserver
   {
      ...
      protected function dispatchSuccess(param1:Uri, param2:uint, param3:*) : void
      {
         ...
         {
            (_loc6_ = new ResourceLoadedEvent(ResourceLoadedEvent.LOADED)).uri = param1;
         ...
         {
            (_loc7_ = new ResourceLoaderProgressEvent(ResourceLoaderProgressEvent.LOADER_PROGRESS)).uri = param1;
      ...
      {
         var _loc4_:ResourceProgressEvent;
         (_loc4_ = new ResourceProgressEvent(ResourceProgressEvent.PROGRESS)).uri = param1;
