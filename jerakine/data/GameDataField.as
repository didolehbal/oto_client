package com.ankamagames.jerakine.data
{
   ...
   public class GameDataField
   {
      ...
      {
         var _loc4_:int;
         if((_loc4_ = param2.readInt()) == NULL_IDENTIFIER)
         {
            return null;
         }
         var _loc5_:GameDataClassDefinition;
         return (_loc5_ = GameDataFileAccessor.getInstance().getClassDefinition(param1,_loc4_)).read(param1,param2);
      }
